#ifndef LANGUAGE_TYPED_AST_TYPES_H
#define LANGUAGE_TYPED_AST_TYPES_H
...
public:
    explicit BasicType(std::type_index type);
...
public:
    explicit InternalType(std::type_index pointer_type);
...
public:
    explicit EnumType(std::type_index type);
