...
void tree<T, tree_node_allocator>::head_initialise_()
{
    head = std::allocator_traits<tree_node_allocator>::allocate(
        alloc_,
        1,
        0); // MSVC does not have default second argument
    feet = std::allocator_traits<tree_node_allocator>::allocate(alloc_, 1, 0);
...
iter tree<T, tree_node_allocator>::append_child(iter position, const T& x)
{
    ...
    tree_node* tmp =
        std::allocator_traits<tree_node_allocator>::allocate(alloc_, 1, 0);
