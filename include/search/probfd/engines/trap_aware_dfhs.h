...
#define GUARD_INCLUDE_PROBFD_ENGINES_TRAP_AWARE_DFHS_H
#include "probfd/engines/trap_aware_dfhs_impl.h"
#undef GUARD_INCLUDE_PROBFD_ENGINES_TRAP_AWARE_DFHS_H
