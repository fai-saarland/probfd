#ifndef LEGACY_MAX_REGRESSION_OPERATORS_H
#define LEGACY_MAX_REGRESSION_OPERATORS_H

#include "algorithms/priority_queues.h"

#include "legacy/merge_and_shrink/max_heuristic.h"
...
class MaxRegressionOperators : public HSPMaxHeuristic {
    ...
    bool enqueue_if_necessary(Proposition* prop, UnaryOperator* op)
    {
        ...
        if (prop->cost == -1 || prop->cost >= cost) {
            ...
            // in case when the cost of the proposition is decreased, need to

            // empty the previously added operators
            ...
            // namespace merge_and_shrink
            // namespace legacy           prop->cost = cost;
