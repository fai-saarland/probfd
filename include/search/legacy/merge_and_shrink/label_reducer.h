#ifndef LEGACY_MERGE_AND_SHRINK_LABEL_REDUCER_H
#define LEGACY_MERGE_AND_SHRINK_LABEL_REDUCER_H
...
inline int LabelReducer::get_op_index(const GlobalOperator* op) const
{
