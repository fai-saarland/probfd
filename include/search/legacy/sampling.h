#ifndef LEGACY_SAMPLING_H
#define LEGACY_SAMPLING_H
...
class RandomWalkSampler {
    const std::shared_ptr<
        successor_generator::SuccessorGenerator<const GlobalOperator*>>
        successor_generator;
...
public:
    ...
    */
    GlobalState sample_state(
        int init_h,
        const DeadEndDetector& is_dead_end = [](const GlobalState&) {
            return false;
        }) const;
};
} // namespace sampling
