#ifndef LEGACY_GLOBALS_H
#define LEGACY_GLOBALS_H
...
extern GlobalState g_initial_state();
...
// for each problem in this case the method GlobalState::get_id would also have
// to be changed.
