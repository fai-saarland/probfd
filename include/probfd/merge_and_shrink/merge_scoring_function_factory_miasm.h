#ifndef PROBFD_MERGE_AND_SHRINK_MERGE_SCORING_FUNCTION_FACTORY_MIASM_H
#define PROBFD_MERGE_AND_SHRINK_MERGE_SCORING_FUNCTION_FACTORY_MIASM_H
...
class MergeScoringFunctionFactoryMIASM : public MergeScoringFunctionFactory {
...
public:
    MergeScoringFunctionFactoryMIASM(
        bool use_caching,
