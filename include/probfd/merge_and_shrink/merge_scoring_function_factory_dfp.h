#ifndef PROBFD_MERGE_AND_SHRINK_MERGE_SCORING_FUNCTION_FACTORY_DFP_H
#define PROBFD_MERGE_AND_SHRINK_MERGE_SCORING_FUNCTION_FACTORY_DFP_H
...
#endif // PROBFD_MERGE_AND_SHRINK_MERGE_SCORING_FUNCTION_FACTORY_DFP_H
