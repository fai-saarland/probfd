(define (domain a-schedule-problem435)
...
(:constants
  ...
  P0 P1 P2 P3 P4 P5 P6 P7 P8 P9 P10 P11 P12 P13 P14 P15 P16 P17 P18 P19 P20 P21 P22 P23 P24 P25 P26 P27 P28 P29 P30 P31 P32 P33 P34 P35 P36 P37 P38 P39 P40 P41 P42 P43 P44 P45 P46 P47 P48 P49 P50 P51 P52 P53 P54 P55 P56 P57 P58 P59 - packet
)
(:predicates
...
(:action process-arrivals-C0
  ...
  :effect (and
    ...
    (probabilistic 1/250 (and (not (available ?arriving-packet)) (time-to-live ?arriving-packet ?t) (packet-class ?arriving-packet C0)))
...
(:action process-arrivals
  ...
  :effect (and
    ...
    (probabilistic 11/90 (and (not (available ?arriving-packet)) (time-to-live ?arriving-packet ?t) (packet-class ?arriving-packet ?c)))
    (increase (total-cost) 1)
  )
)
(:action time-update
  ...
  :precondition (and
    ...
    (not (need-to-process-arrivals C7))
    (not (need-to-process-arrivals C8))
    (not (need-to-process-arrivals C9))
  )
  :effect (and
...
(:action packet-serve
  ...
  :precondition (and
    ...
    (not (time-to-live P42 ?t))
    (not (time-to-live P43 ?t))
    (not (time-to-live P44 ?t))
    (not (time-to-live P45 ?t))
    (not (time-to-live P46 ?t))
    (not (time-to-live P47 ?t))
    (not (time-to-live P48 ?t))
    (not (time-to-live P49 ?t))
    (not (time-to-live P50 ?t))
    (not (time-to-live P51 ?t))
    (not (time-to-live P52 ?t))
    (not (time-to-live P53 ?t))
    (not (time-to-live P54 ?t))
    (not (time-to-live P55 ?t))
    (not (time-to-live P56 ?t))
    (not (time-to-live P57 ?t))
    (not (time-to-live P58 ?t))
    (not (time-to-live P59 ?t))
  )
  :effect (and
