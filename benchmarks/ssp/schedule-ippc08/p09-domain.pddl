(define (domain a-schedule-problem602)
...
(:constants
  ...
  P0 P1 P2 P3 P4 P5 P6 P7 P8 P9 P10 P11 P12 P13 P14 P15 P16 P17 P18 P19 P20 P21 P22 P23 - packet
)
(:predicates
...
(:action process-arrivals-C0
  ...
  :effect (and
    ...
    (probabilistic 3/500 (and (not (available ?arriving-packet)) (time-to-live ?arriving-packet ?t) (packet-class ?arriving-packet C0)))
...
(:action process-arrivals
  ...
  :effect (and
    ...
    (probabilistic 11/30 (and (not (available ?arriving-packet)) (time-to-live ?arriving-packet ?t) (packet-class ?arriving-packet ?c)))
    (increase (total-cost) 1)
  )
)
(:action time-update
