(define (domain canadian-transport-l8-e12-t1-p4--minP200--maxP200--s292455)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l0) (road-status r0 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r0 clear) (at l7) (not (at l0)))))
)
(:action drive-l0-l7
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l7-l0
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l7) (road-status r0 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r0 unknown))
    (probabilistic
            200/1000 (and (road-status r0 blocked))
            800/1000 (and (road-status r0 clear) (at l0) (not (at l7)))))
)
(:action drive-l7-l0
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l7) (road-status r0 clear))
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l2) (road-status r7 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r7 clear) (at l6) (not (at l2)))))
)
(:action drive-l2-l6
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l6-l2
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l6) (road-status r7 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r7 unknown))
    (probabilistic
            200/1000 (and (road-status r7 blocked))
            800/1000 (and (road-status r7 clear) (at l2) (not (at l6)))))
)
(:action drive-l6-l2
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l6) (road-status r7 clear))
