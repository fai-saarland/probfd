(define (domain dom--tpp-m7-g4-s717101)
...
(:action try-drive-m2-m3
    ...
    800/1000 (and (road_isfree road4) (not (at ?t market2)) (at ?t market3)))))
...
(:action try-drive-m3-m2
    ...
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road4)) (probabilistic
    200/1000 (and (road_isblocked road4))
    800/1000 (and (road_isfree road4) (not (at ?t market3)) (at ?t market2)))))
...
(:action try-drive-m2-m5
    ...
    800/1000 (and (road_isfree road5) (not (at ?t market2)) (at ?t market5)))))
...
(:action try-drive-m5-m2
    ...
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road5)) (probabilistic
    200/1000 (and (road_isblocked road5))
    800/1000 (and (road_isfree road5) (not (at ?t market5)) (at ?t market2)))))
...
(:action try-drive-m2-m6
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isunknown road6) (at ?t market2))
    ...
    800/1000 (and (road_isfree road6) (not (at ?t market2)) (at ?t market6)))))

(:action drive-m2-m6
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road6) (at ?t market2))
...
(:action try-drive-m6-m2
    ...
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road6)) (probabilistic
    200/1000 (and (road_isblocked road6))
    800/1000 (and (road_isfree road6) (not (at ?t market6)) (at ?t market2)))))
