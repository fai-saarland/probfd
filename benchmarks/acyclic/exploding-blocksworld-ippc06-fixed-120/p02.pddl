(define (problem ex_bw_5_15874)
  ...
  (:objects horzn0 horzn2 horzn3 horzn4 horzn5 - horizon-value b1 b2 b3 b4 b5 - block)
  (:init (horizon horzn5) (horizon-decrement horzn1 horzn1 horzn0) (horizon-decrement horzn2 horzn1 horzn1) (horizon-decrement horzn3 horzn1 horzn2) (horizon-decrement horzn4 horzn1 horzn3) (horizon-decrement horzn5 horzn1 horzn4) (emptyhand) (on-table b1) (on b2 b3) (on-table b3) (on b4 b5) (on-table b5) (clear b1) (clear b2) (clear b4) (no-detonated b1) (no-destroyed b1) (no-detonated b2) (no-destroyed b2) (no-detonated b3) (no-destroyed b3) (no-detonated b4) (no-destroyed b4) (no-detonated b5) (no-destroyed b5) (no-destroyed-table))
