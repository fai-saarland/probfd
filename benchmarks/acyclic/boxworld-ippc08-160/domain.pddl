...
(define (domain boxworld)
 ...
 (:predicates (horizon ?h - horizon-value) (horizon-decrement ?h0 ?h1 - horizon-value) (box-at-city ?b - box ?c - city)
 ...
 (:action load-box-on-truck-in-city
  ...
  :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (box-at-city ?b ?c)
                     (not (destination ?b ?c))
                     (truck-at-city ?t ?c)
                )
 ...
 (:action unload-box-from-truck-in-city
  :parameters (?hcur ?hnew - horizon-value ?b - box ?t - truck ?c - city)
  :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (box-on-truck ?b ?t)
                     (truck-at-city ?t ?c)
                )
  :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1)
               (box-at-city ?b ?c)
 ...
 (:action unload-box-from-plane-in-city
  :parameters (?hcur ?hnew - horizon-value ?b - box ?p - plane ?c - city)
  :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (box-on-plane ?b ?p)
                     (plane-at-city ?p ?c)
                )
  :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1)
               (box-at-city ?b ?c)
 ...
 (:action drive-truck
  ...
  :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (truck-at-city ?t ?src)
                     (can-drive ?src ?dst)
                     (wrong-drive1 ?src ?w1)
                     (wrong-drive2 ?src ?w2)
                     (wrong-drive3 ?src ?w3)
 ...
 (:action fly-plane
  ...
  :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (plane-at-city ?p ?src)
                     (can-fly ?src ?dst)
                )
  :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1)
