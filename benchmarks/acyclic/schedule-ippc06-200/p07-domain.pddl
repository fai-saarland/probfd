(define
  ...
  (:constants horzn1 - horizon-value  C0 C1 C2 - class Arrivals-and-updating Cleanup-and-service - phase U0 U1 U2 U3 - timestep P0 P1 P2 P3 P4 P5 P6 P7 P8 - packet)
  ...
  (:action packet-serve
    ...
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur horzn1 ?hnew) (current-phase Cleanup-and-service) (packet-class ?p ?c) (current-timestep ?t) (not (time-to-live P0 ?t)) (not (time-to-live P1 ?t)) (not (time-to-live P2 ?t)) (not (time-to-live P3 ?t)) (not (time-to-live P4 ?t)) (not (time-to-live P5 ?t)) (not (time-to-live P6 ?t)) (not (time-to-live P7 ?t)) (not (time-to-live P8 ?t)))
  ...
  (:action serve-nothing
    ...
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur horzn1 ?hnew) (current-phase Cleanup-and-service) (current-timestep ?t) (not (time-to-live P0 ?t)) (not (time-to-live P1 ?t)) (not (time-to-live P2 ?t)) (not (time-to-live P3 ?t)) (not (time-to-live P4 ?t)) (not (time-to-live P5 ?t)) (not (time-to-live P6 ?t)) (not (time-to-live P7 ?t)) (not (time-to-live P8 ?t)))
