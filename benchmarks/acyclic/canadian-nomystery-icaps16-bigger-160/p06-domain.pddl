(define (domain canadian-transport-l8-e12-t1-p4--minP200--maxP200--s611752)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l0) (road-status r0 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r0 clear) (at l5) (not (at l0)))))
)
(:action drive-l0-l5
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l5-l0
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l5) (road-status r0 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r0 unknown))
    (probabilistic
            200/1000 (and (road-status r0 blocked))
            800/1000 (and (road-status r0 clear) (at l0) (not (at l5)))))
)
(:action drive-l5-l0
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l5) (road-status r0 clear))
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l0) (road-status r1 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r1 clear) (at l6) (not (at l0)))))
)
(:action drive-l0-l6
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l6-l0
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l6) (road-status r1 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r1 unknown))
    (probabilistic
            200/1000 (and (road-status r1 blocked))
            800/1000 (and (road-status r1 clear) (at l0) (not (at l6)))))
)
(:action drive-l6-l0
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l6) (road-status r1 clear))
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l0) (road-status r2 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r2 clear) (at l7) (not (at l0)))))
)
(:action drive-l0-l7
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l7-l0
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l7) (road-status r2 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r2 unknown))
    (probabilistic
            200/1000 (and (road-status r2 blocked))
            800/1000 (and (road-status r2 clear) (at l0) (not (at l7)))))
)
(:action drive-l7-l0
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l7) (road-status r2 clear))
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l1) (road-status r3 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r3 clear) (at l3) (not (at l1)))))
)
(:action drive-l1-l3
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l3-l1
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l3) (road-status r3 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r3 unknown))
    (probabilistic
            200/1000 (and (road-status r3 blocked))
            800/1000 (and (road-status r3 clear) (at l1) (not (at l3)))))
)
(:action drive-l3-l1
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l3) (road-status r3 clear))
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l1) (road-status r4 clear))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (at l6) (not (at l1)))
)
(:action try-driving-l6-l1
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l6) (road-status r4 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r4 unknown))
    (probabilistic
            200/1000 (and (road-status r4 blocked))
...
(:action drive-l6-l1
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l6) (road-status r4 clear))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (at l1) (not (at l6)))
)
