(define (domain canadian-transport-l8-e12-t1-p4--minP200--maxP200--s773243)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l0) (road-status r1 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r1 clear) (at l3) (not (at l0)))))
)
(:action drive-l0-l3
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l3-l0
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l3) (road-status r1 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r1 unknown))
    (probabilistic
            200/1000 (and (road-status r1 blocked))
            800/1000 (and (road-status r1 clear) (at l0) (not (at l3)))))
)
(:action drive-l3-l0
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l3) (road-status r1 clear))
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l0) (road-status r2 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r2 clear) (at l4) (not (at l0)))))
)
(:action drive-l0-l4
    :parameters (?hcur ?hnew - horizon-value)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l4) (road-status r2 unknown))
    ...
    (probabilistic
            200/1000 (and (road-status r2 blocked))
            800/1000 (and (road-status r2 clear) (at l0) (not (at l4)))))
)
(:action drive-l4-l0
    :parameters (?hcur ?hnew - horizon-value)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l0) (road-status r3 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r3 clear) (at l5) (not (at l0)))))
)
(:action drive-l0-l5
    :parameters (?hcur ?hnew - horizon-value)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l5) (road-status r3 unknown))
    ...
    (probabilistic
            200/1000 (and (road-status r3 blocked))
            800/1000 (and (road-status r3 clear) (at l0) (not (at l5)))))
)
(:action drive-l5-l0
    :parameters (?hcur ?hnew - horizon-value)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l2) (road-status r7 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r7 clear) (at l4) (not (at l2)))))
)
(:action drive-l2-l4
    :parameters (?hcur ?hnew - horizon-value)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l4) (road-status r7 unknown))
    ...
    (probabilistic
            200/1000 (and (road-status r7 blocked))
            800/1000 (and (road-status r7 clear) (at l2) (not (at l4)))))
)
(:action drive-l4-l2
    :parameters (?hcur ?hnew - horizon-value)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l3) (road-status r8 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r8 clear) (at l5) (not (at l3)))))
)
(:action drive-l3-l5
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l5-l3
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l5) (road-status r8 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r8 unknown))
    (probabilistic
            200/1000 (and (road-status r8 blocked))
            800/1000 (and (road-status r8 clear) (at l3) (not (at l5)))))
)
(:action drive-l5-l3
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l5) (road-status r8 clear))
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l3) (road-status r9 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r9 clear) (at l6) (not (at l3)))))
)
(:action drive-l3-l6
    :parameters (?hcur ?hnew - horizon-value)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l6) (road-status r9 unknown))
    ...
    (probabilistic
            200/1000 (and (road-status r9 blocked))
            800/1000 (and (road-status r9 clear) (at l3) (not (at l6)))))
)
(:action drive-l6-l3
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l3-l7
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l3) (road-status r10 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r10 clear) (at l7) (not (at l3)))))
)
(:action drive-l3-l7
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l3) (road-status r10 clear))
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l7) (road-status r10 unknown))
    ...
    (probabilistic
            200/1000 (and (road-status r10 blocked))
            800/1000 (and (road-status r10 clear) (at l3) (not (at l7)))))
)
(:action drive-l7-l3
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l4-l7
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l4) (road-status r11 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r11 clear) (at l7) (not (at l4)))))
)
(:action drive-l4-l7
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l4) (road-status r11 clear))
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l7) (road-status r11 unknown))
    ...
    (probabilistic
            200/1000 (and (road-status r11 blocked))
            800/1000 (and (road-status r11 clear) (at l4) (not (at l7)))))
)
(:action drive-l7-l4
    :parameters (?hcur ?hnew - horizon-value)
