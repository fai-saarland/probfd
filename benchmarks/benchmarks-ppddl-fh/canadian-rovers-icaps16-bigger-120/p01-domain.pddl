(define (domain roverdom--s228388--m25--r2--w6--o3--c1--g4--p0--P1--Z200--X200--C10)
(:requirements :typing)
...
(:constants road0 road1 road2 road3 road4 road5 road6 road7 road8 road9 road10 road11 road12 road13 - road
...
(:action try-navigate-l2-l4
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint2 waypoint4) (available ?x) (at ?x waypoint2) (visible waypoint2 waypoint4) (road_isunknown road9))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road9)) (probabilistic 
        ...
        800/1000 (and (road_isfree road9) (not (at ?x waypoint2)) (at ?x waypoint4))
    ))
)

(:action navigate-l2-l4
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint2 waypoint4) (available ?x) (at ?x waypoint2) (visible waypoint2 waypoint4) (road_isfree road9))
...
(:action try-navigate-l4-l2
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint4 waypoint2) (available ?x) (at ?x waypoint4) (visible waypoint4 waypoint2) (road_isunknown road9))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road9)) (probabilistic 
        200/1000 (and (road_isblocked road9))
        800/1000 (and (road_isfree road9) (not (at ?x waypoint4)) (at ?x waypoint2))
    ))
)

(:action navigate-l4-l2
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint4 waypoint2) (available ?x) (at ?x waypoint4) (visible waypoint4 waypoint2) (road_isfree road9))
...
(:action try-navigate-l2-l5
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint2 waypoint5) (available ?x) (at ?x waypoint2) (visible waypoint2 waypoint5) (road_isunknown road10))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road10)) (probabilistic 
        ...
        800/1000 (and (road_isfree road10) (not (at ?x waypoint2)) (at ?x waypoint5))
    ))
)

(:action navigate-l2-l5
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint2 waypoint5) (available ?x) (at ?x waypoint2) (visible waypoint2 waypoint5) (road_isfree road10))
...
(:action try-navigate-l5-l2
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint5 waypoint2) (available ?x) (at ?x waypoint5) (visible waypoint5 waypoint2) (road_isunknown road10))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road10)) (probabilistic 
        200/1000 (and (road_isblocked road10))
        800/1000 (and (road_isfree road10) (not (at ?x waypoint5)) (at ?x waypoint2))
    ))
)

(:action navigate-l5-l2
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint5 waypoint2) (available ?x) (at ?x waypoint5) (visible waypoint5 waypoint2) (road_isfree road10))
...
(:action try-navigate-l3-l4
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint3 waypoint4) (available ?x) (at ?x waypoint3) (visible waypoint3 waypoint4) (road_isunknown road11))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road11)) (probabilistic 
        ...
        800/1000 (and (road_isfree road11) (not (at ?x waypoint3)) (at ?x waypoint4))
    ))
)

(:action navigate-l3-l4
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint3 waypoint4) (available ?x) (at ?x waypoint3) (visible waypoint3 waypoint4) (road_isfree road11))
...
(:action try-navigate-l4-l3
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint4 waypoint3) (available ?x) (at ?x waypoint4) (visible waypoint4 waypoint3) (road_isunknown road11))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road11)) (probabilistic 
        200/1000 (and (road_isblocked road11))
        800/1000 (and (road_isfree road11) (not (at ?x waypoint4)) (at ?x waypoint3))
    ))
)

(:action navigate-l4-l3
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint4 waypoint3) (available ?x) (at ?x waypoint4) (visible waypoint4 waypoint3) (road_isfree road11))
...
(:action try-navigate-l3-l5
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint3 waypoint5) (available ?x) (at ?x waypoint3) (visible waypoint3 waypoint5) (road_isunknown road12))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road12)) (probabilistic 
        ...
        800/1000 (and (road_isfree road12) (not (at ?x waypoint3)) (at ?x waypoint5))
    ))
)

(:action navigate-l3-l5
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint3 waypoint5) (available ?x) (at ?x waypoint3) (visible waypoint3 waypoint5) (road_isfree road12))
...
(:action try-navigate-l5-l3
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint5 waypoint3) (available ?x) (at ?x waypoint5) (visible waypoint5 waypoint3) (road_isunknown road12))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road12)) (probabilistic 
        200/1000 (and (road_isblocked road12))
        800/1000 (and (road_isfree road12) (not (at ?x waypoint5)) (at ?x waypoint3))
    ))
)

(:action navigate-l5-l3
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint5 waypoint3) (available ?x) (at ?x waypoint5) (visible waypoint5 waypoint3) (road_isfree road12))
...
(:action try-navigate-l4-l5
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint4 waypoint5) (available ?x) (at ?x waypoint4) (visible waypoint4 waypoint5) (road_isunknown road13))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road13)) (probabilistic 
        ...
        800/1000 (and (road_isfree road13) (not (at ?x waypoint4)) (at ?x waypoint5))
    ))
)

(:action navigate-l4-l5
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint4 waypoint5) (available ?x) (at ?x waypoint4) (visible waypoint4 waypoint5) (road_isfree road13))
...
(:action try-navigate-l5-l4
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint5 waypoint4) (available ?x) (at ?x waypoint5) (visible waypoint5 waypoint4) (road_isunknown road13))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road13)) (probabilistic 
        200/1000 (and (road_isblocked road13))
        800/1000 (and (road_isfree road13) (not (at ?x waypoint5)) (at ?x waypoint4))
    ))
)

(:action navigate-l5-l4
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint5 waypoint4) (available ?x) (at ?x waypoint5) (visible waypoint5 waypoint4) (road_isfree road13))
