(define (domain canadian-transport-l8-e12-t1-p4--minP200--maxP200--s717101)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l1) (road-status r4 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r4 clear) (at l4) (not (at l1)))))
)
(:action drive-l1-l4
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l4-l1
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l4) (road-status r4 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r4 unknown))
    (probabilistic
            200/1000 (and (road-status r4 blocked))
            800/1000 (and (road-status r4 clear) (at l1) (not (at l4)))))
)
(:action drive-l4-l1
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l4) (road-status r4 clear))
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l1) (road-status r5 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r5 clear) (at l7) (not (at l1)))))
)
(:action drive-l1-l7
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l7-l1
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l7) (road-status r5 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r5 unknown))
    (probabilistic
            200/1000 (and (road-status r5 blocked))
            800/1000 (and (road-status r5 clear) (at l1) (not (at l7)))))
)
(:action drive-l7-l1
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l7) (road-status r5 clear))
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l2) (road-status r6 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r6 clear) (at l3) (not (at l2)))))
)
(:action drive-l2-l3
    :parameters (?hcur ?hnew - horizon-value)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l3) (road-status r6 unknown))
    ...
    (probabilistic
            200/1000 (and (road-status r6 blocked))
            800/1000 (and (road-status r6 clear) (at l2) (not (at l3)))))
)
(:action drive-l3-l2
    :parameters (?hcur ?hnew - horizon-value)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l4) (road-status r8 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r8 clear) (at l5) (not (at l4)))))
)
(:action drive-l4-l5
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l4) (road-status r8 clear))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (at l5) (not (at l4)))
)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l5) (road-status r8 unknown))
    ...
    (probabilistic
            200/1000 (and (road-status r8 blocked))
            800/1000 (and (road-status r8 clear) (at l4) (not (at l5)))))
)
(:action drive-l5-l4
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l5) (road-status r8 clear))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (at l4) (not (at l5)))
)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l4) (road-status r10 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r10 clear) (at l7) (not (at l4)))))
)
(:action drive-l4-l7
    :parameters (?hcur ?hnew - horizon-value)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l7) (road-status r10 unknown))
    ...
    (probabilistic
            200/1000 (and (road-status r10 blocked))
            800/1000 (and (road-status r10 clear) (at l4) (not (at l7)))))
)
(:action drive-l7-l4
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l5-l6
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l5) (road-status r11 unknown))
...
(:action drive-l5-l6
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l5) (road-status r11 clear))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (at l6) (not (at l5)))
)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l6) (road-status r11 clear))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (at l5) (not (at l6)))
)
)
