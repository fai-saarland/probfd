(define (domain roverdom--s611752--m25--r2--w6--o3--c1--g4--p0--P1--Z200--X200--C10)
(:requirements :typing)
...
(:action try-navigate-l1-l2
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint1 waypoint2) (available ?x) (at ?x waypoint1) (visible waypoint1 waypoint2) (road_isunknown road3))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road3)) (probabilistic 
        ...
        800/1000 (and (road_isfree road3) (not (at ?x waypoint1)) (at ?x waypoint2))
    ))
)

(:action navigate-l1-l2
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint1 waypoint2) (available ?x) (at ?x waypoint1) (visible waypoint1 waypoint2) (road_isfree road3))
...
(:action try-navigate-l2-l1
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint2 waypoint1) (available ?x) (at ?x waypoint2) (visible waypoint2 waypoint1) (road_isunknown road3))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road3)) (probabilistic 
        200/1000 (and (road_isblocked road3))
        800/1000 (and (road_isfree road3) (not (at ?x waypoint2)) (at ?x waypoint1))
    ))
)

(:action navigate-l2-l1
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint2 waypoint1) (available ?x) (at ?x waypoint2) (visible waypoint2 waypoint1) (road_isfree road3))
...
(:action try-navigate-l1-l3
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint1 waypoint3) (available ?x) (at ?x waypoint1) (visible waypoint1 waypoint3) (road_isunknown road4))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road4)) (probabilistic 
        ...
        800/1000 (and (road_isfree road4) (not (at ?x waypoint1)) (at ?x waypoint3))
    ))
)

(:action navigate-l1-l3
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint1 waypoint3) (available ?x) (at ?x waypoint1) (visible waypoint1 waypoint3) (road_isfree road4))
...
(:action try-navigate-l3-l1
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint3 waypoint1) (available ?x) (at ?x waypoint3) (visible waypoint3 waypoint1) (road_isunknown road4))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road4)) (probabilistic 
        200/1000 (and (road_isblocked road4))
        800/1000 (and (road_isfree road4) (not (at ?x waypoint3)) (at ?x waypoint1))
    ))
)

(:action navigate-l3-l1
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint3 waypoint1) (available ?x) (at ?x waypoint3) (visible waypoint3 waypoint1) (road_isfree road4))
...
(:action try-navigate-l1-l4
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint1 waypoint4) (available ?x) (at ?x waypoint1) (visible waypoint1 waypoint4) (road_isunknown road5))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road5)) (probabilistic 
        ...
        800/1000 (and (road_isfree road5) (not (at ?x waypoint1)) (at ?x waypoint4))
    ))
)

(:action navigate-l1-l4
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint1 waypoint4) (available ?x) (at ?x waypoint1) (visible waypoint1 waypoint4) (road_isfree road5))
...
(:action try-navigate-l4-l1
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint4 waypoint1) (available ?x) (at ?x waypoint4) (visible waypoint4 waypoint1) (road_isunknown road5))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road5)) (probabilistic 
        200/1000 (and (road_isblocked road5))
        800/1000 (and (road_isfree road5) (not (at ?x waypoint4)) (at ?x waypoint1))
    ))
)

(:action navigate-l4-l1
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint4 waypoint1) (available ?x) (at ?x waypoint4) (visible waypoint4 waypoint1) (road_isfree road5))
...
(:action try-navigate-l1-l5
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint1 waypoint5) (available ?x) (at ?x waypoint1) (visible waypoint1 waypoint5) (road_isunknown road6))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road6)) (probabilistic 
        ...
        800/1000 (and (road_isfree road6) (not (at ?x waypoint1)) (at ?x waypoint5))
    ))
)

(:action navigate-l1-l5
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint1 waypoint5) (available ?x) (at ?x waypoint1) (visible waypoint1 waypoint5) (road_isfree road6))
...
(:action try-navigate-l5-l1
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint5 waypoint1) (available ?x) (at ?x waypoint5) (visible waypoint5 waypoint1) (road_isunknown road6))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road6)) (probabilistic 
        200/1000 (and (road_isblocked road6))
        800/1000 (and (road_isfree road6) (not (at ?x waypoint5)) (at ?x waypoint1))
    ))
)

(:action navigate-l5-l1
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint5 waypoint1) (available ?x) (at ?x waypoint5) (visible waypoint5 waypoint1) (road_isfree road6))
...
(:action try-navigate-l2-l3
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint2 waypoint3) (available ?x) (at ?x waypoint2) (visible waypoint2 waypoint3) (road_isunknown road7))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road7)) (probabilistic 
        ...
        800/1000 (and (road_isfree road7) (not (at ?x waypoint2)) (at ?x waypoint3))
    ))
)

(:action navigate-l2-l3
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint2 waypoint3) (available ?x) (at ?x waypoint2) (visible waypoint2 waypoint3) (road_isfree road7))
...
(:action try-navigate-l3-l2
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint3 waypoint2) (available ?x) (at ?x waypoint3) (visible waypoint3 waypoint2) (road_isunknown road7))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road7)) (probabilistic 
        200/1000 (and (road_isblocked road7))
        800/1000 (and (road_isfree road7) (not (at ?x waypoint3)) (at ?x waypoint2))
    ))
)

(:action navigate-l3-l2
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint3 waypoint2) (available ?x) (at ?x waypoint3) (visible waypoint3 waypoint2) (road_isfree road7))
