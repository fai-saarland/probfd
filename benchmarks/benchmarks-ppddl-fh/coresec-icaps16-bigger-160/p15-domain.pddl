;;; H=24 E=[1, 1, 22] T=[1, 1, 11] Sub=3 1-per=40 Seed=324241(2140687749857675880)
...
(:predicates (horizon ?h - horizon-value) (horizon-decrement ?h0 ?h1 - horizon-value)
    ...
    (expl_host23_winNT4ent_SQL4_vuln42)
    ...
    (expl_host12_win2000adv_SQL5_vuln64)
    ...
    (expl_host23_win2000adv_SQL5_vuln64)
...
(:constants
    host0 host1 host2 host3 host4 host5 host6 host7 host8 host9 host10 host11 host12 host13 host14 host15 host16 host17 host18 host19 host20 host21 host22 host23 internet - host
    p80 p3306 p445 - port
)
...
(:action ex-host12_win2000adv_SQL5_vuln64
    :parameters (?hcur ?hnew - horizon-value ?src - host)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (hacl ?src host12 p3306) (controlling ?src) (expl_host12_win2000adv_SQL5_vuln64))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (expl_host12_win2000adv_SQL5_vuln64)) (probabilistic 73/100 (and (controlling host12))))
)
...
(:action ex-host23_win2000adv_SQL5_vuln64
    :parameters (?hcur ?hnew - horizon-value ?src - host)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (hacl ?src host23 p3306) (controlling ?src) (expl_host23_win2000adv_SQL5_vuln64))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (expl_host23_win2000adv_SQL5_vuln64)) (probabilistic 73/100 (and (controlling host23))))
)

(:action ex-host23_winNT4ent_SQL4_vuln42
    :parameters (?hcur ?hnew - horizon-value ?src - host)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (hacl ?src host23 p3306) (controlling ?src) (expl_host23_winNT4ent_SQL4_vuln42))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (expl_host23_winNT4ent_SQL4_vuln42)) (probabilistic 65/100 (and (controlling host23))))
)
