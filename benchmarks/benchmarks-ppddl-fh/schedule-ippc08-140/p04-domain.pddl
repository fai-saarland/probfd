(define (domain a-schedule-problem697)
...
(:constants
  ...
  P0 P1 P2 P3 P4 P5 P6 P7 - packet
)
...
(:action process-arrivals-C0
  ...
  :effect (and (not (horizon ?hcur)) (horizon ?hnew)
    ...
    (probabilistic 11/125 (and (not (available ?arriving-packet)) (time-to-live ?arriving-packet ?t) (packet-class ?arriving-packet C0)))
