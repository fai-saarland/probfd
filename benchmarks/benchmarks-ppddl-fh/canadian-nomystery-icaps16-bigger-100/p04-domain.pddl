(define (domain canadian-transport-l8-e12-t1-p4--minP200--maxP200--s488595)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l1) (road-status r6 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r6 clear) (at l7) (not (at l1)))))
)
(:action drive-l1-l7
    :parameters (?hcur ?hnew - horizon-value)
...
(:action try-driving-l7-l1
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l7) (road-status r6 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r6 unknown))
    (probabilistic
            200/1000 (and (road-status r6 blocked))
            800/1000 (and (road-status r6 clear) (at l1) (not (at l7)))))
)
(:action drive-l7-l1
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l7) (road-status r6 clear))
...
(:action try-driving-l5-l4
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l5) (road-status r9 unknown))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road-status r9 unknown))
    (probabilistic
            200/1000 (and (road-status r9 blocked))
...
(:action drive-l5-l4
    :parameters (?hcur ?hnew - horizon-value)
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l5) (road-status r9 clear))
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l5) (road-status r11 unknown))
    ...
    (probabilistic
            ...
            800/1000 (and (road-status r11 clear) (at l7) (not (at l5)))))
)
(:action drive-l5-l7
    :parameters (?hcur ?hnew - horizon-value)
...
:precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at l7) (road-status r11 unknown))
    ...
    (probabilistic
            200/1000 (and (road-status r11 blocked))
            800/1000 (and (road-status r11 clear) (at l5) (not (at l7)))))
)
(:action drive-l7-l5
    :parameters (?hcur ?hnew - horizon-value)
