(define (domain a-schedule-problem776)
...
(:constants
  ...
  P0 P1 P2 P3 P4 P5 P6 P7 P8 P9 P10 P11 - packet
)
...
(:action process-arrivals-C0
  ...
  :effect (and (not (horizon ?hcur)) (horizon ?hnew)
    ...
    (probabilistic 1/100 (and (not (available ?arriving-packet)) (time-to-live ?arriving-packet ?t) (packet-class ?arriving-packet C0)))
...
(:action process-arrivals
  ...
  :effect (and (not (horizon ?hcur)) (horizon ?hnew)
    ...
    (probabilistic 11/20 (and (not (available ?arriving-packet)) (time-to-live ?arriving-packet ?t) (packet-class ?arriving-packet ?c)))
    (increase (total-cost) 1)
  )
)
(:action time-update
