(define (domain dom--tpp-m7-g4-s292455)
...
(:action try-drive-m0-m7
    ...
    800/1000 (and (road_isfree road2) (not (at ?t depot0)) (at ?t market7)))))
...
(:action try-drive-m7-m0
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isunknown road2) (at ?t market7))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road2)) (probabilistic
    200/1000 (and (road_isblocked road2))
    800/1000 (and (road_isfree road2) (not (at ?t market7)) (at ?t depot0)))))

(:action drive-m7-m0
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road2) (at ?t market7))
...
(:action try-drive-m3-m7
    ...
    800/1000 (and (road_isfree road4) (not (at ?t market3)) (at ?t market7)))))
...
(:action try-drive-m7-m3
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isunknown road4) (at ?t market7))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road4)) (probabilistic
    200/1000 (and (road_isblocked road4))
    800/1000 (and (road_isfree road4) (not (at ?t market7)) (at ?t market3)))))

(:action drive-m7-m3
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road4) (at ?t market7))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t market7)) (at ?t market3)))

(:action try-drive-m4-m5
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isunknown road5) (at ?t market4))
    ...
    800/1000 (and (road_isfree road5) (not (at ?t market4)) (at ?t market5)))))

(:action drive-m4-m5
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road5) (at ?t market4))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t market4)) (at ?t market5)))

(:action try-drive-m5-m4
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isunknown road5) (at ?t market5))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road5)) (probabilistic
    200/1000 (and (road_isblocked road5))
    800/1000 (and (road_isfree road5) (not (at ?t market5)) (at ?t market4)))))

(:action drive-m5-m4
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road5) (at ?t market5))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t market5)) (at ?t market4)))

(:action try-drive-m4-m6
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isunknown road6) (at ?t market4))
    ...
    800/1000 (and (road_isfree road6) (not (at ?t market4)) (at ?t market6)))))

(:action drive-m4-m6
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road6) (at ?t market4))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t market4)) (at ?t market6)))

(:action try-drive-m6-m4
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isunknown road6) (at ?t market6))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road6)) (probabilistic
    200/1000 (and (road_isblocked road6))
    800/1000 (and (road_isfree road6) (not (at ?t market6)) (at ?t market4)))))

(:action drive-m6-m4
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road6) (at ?t market6))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t market6)) (at ?t market4)))
