(define (domain dom--tpp-m7-g4-s611752)
...
(:action try-drive-m0-m3
    ...
    800/1000 (and (road_isfree road0) (not (at ?t depot0)) (at ?t market3)))))
...
(:action try-drive-m3-m0
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isunknown road0) (at ?t market3))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road0)) (probabilistic
    200/1000 (and (road_isblocked road0))
    800/1000 (and (road_isfree road0) (not (at ?t market3)) (at ?t depot0)))))

(:action drive-m3-m0
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road0) (at ?t market3))
...
(:action try-drive-m0-m5
    ...
    800/1000 (and (road_isfree road1) (not (at ?t depot0)) (at ?t market5)))))
...
(:action try-drive-m5-m0
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isunknown road1) (at ?t market5))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road1)) (probabilistic
    200/1000 (and (road_isblocked road1))
    800/1000 (and (road_isfree road1) (not (at ?t market5)) (at ?t depot0)))))

(:action drive-m5-m0
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road1) (at ?t market5))
...
(:action try-drive-m2-m7
    ...
    800/1000 (and (road_isfree road4) (not (at ?t market2)) (at ?t market7)))))
...
(:action try-drive-m7-m2
    ...
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road4)) (probabilistic
    200/1000 (and (road_isblocked road4))
    800/1000 (and (road_isfree road4) (not (at ?t market7)) (at ?t market2)))))
...
(:action try-drive-m4-m5
    ...
    800/1000 (and (road_isfree road6) (not (at ?t market4)) (at ?t market5)))))
...
(:action try-drive-m5-m4
    ...
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road6)) (probabilistic
    200/1000 (and (road_isblocked road6))
    800/1000 (and (road_isfree road6) (not (at ?t market5)) (at ?t market4)))))
