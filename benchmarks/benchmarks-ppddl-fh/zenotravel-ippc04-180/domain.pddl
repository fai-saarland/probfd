(define (domain zenotravel)
  ...
  (:predicates (horizon ?h - horizon-value) (horizon-decrement ?h0 ?h1 - horizon-value) (at-person ?p - person ?c - city)
  ...
  (:action start-boarding
    ...
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at-person ?p ?c) (at-aircraft ?a ?c))
  ...
  (:action complete-boarding
    :parameters (?hcur ?hnew - horizon-value ?p - person ?a - aircraft ?c - city)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (boarding ?p ?a) (at-aircraft ?a ?c))
  ...
  (:action start-debarking
    :parameters (?hcur ?hnew - horizon-value ?p - person ?a - aircraft ?c - city)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (in ?p ?a) (at-aircraft ?a ?c))
  ...
  (:action complete-debarking
    :parameters (?hcur ?hnew - horizon-value ?p - person ?a - aircraft ?c - city)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (debarking ?p ?a) (at-aircraft ?a ?c))
  ...
  (:action start-flying
    ...
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at-aircraft ?a ?c1) (fuel-level ?a ?l1) (next ?l2 ?l1) (not-refueling ?a)
  ...
  (:action complete-flying
    ...
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (flying ?a ?c2) (fuel-level ?a ?l1) (next ?l2 ?l1))
  ...
  (:action start-zooming
    ...
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at-aircraft ?a ?c1) (fuel-level ?a ?l1) (next ?l2 ?l1) (next ?l3 ?l2) (not-refueling ?a)
                       (forall (?p - person) (and (not-boarding ?p) (not-debarking ?p))))
  ...
  (:action complete-zooming
   ...
   :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (zooming ?a ?c2) (fuel-level ?a ?l1) (next ?l2 ?l1) (next ?l3 ?l2))
  ...
  (:action start-refueling
    ...
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (at-aircraft ?a ?c) (not-refueling ?a) (fuel-level ?a ?l) (next ?l ?l1))
  ...
  (:action complete-refuling
    ...
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (refueling ?a) (fuel-level ?a ?l) (next ?l ?l1))
