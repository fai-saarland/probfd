(define (domain dom--tpp-m7-g4-s299974)
...
(:action try-drive-m0-m3
    ...
    800/1000 (and (road_isfree road1) (not (at ?t depot0)) (at ?t market3)))))

(:action drive-m0-m3
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road1) (at ?t depot0))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t depot0)) (at ?t market3)))

(:action try-drive-m3-m0
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isunknown road1) (at ?t market3))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road1)) (probabilistic
    200/1000 (and (road_isblocked road1))
    800/1000 (and (road_isfree road1) (not (at ?t market3)) (at ?t depot0)))))

(:action drive-m3-m0
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road1) (at ?t market3))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t market3)) (at ?t depot0)))
...
(:action try-drive-m0-m4
    ...
    800/1000 (and (road_isfree road2) (not (at ?t depot0)) (at ?t market4)))))
...
(:action try-drive-m4-m0
    ...
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road2)) (probabilistic
    200/1000 (and (road_isblocked road2))
    800/1000 (and (road_isfree road2) (not (at ?t market4)) (at ?t depot0)))))
...
(:action try-drive-m3-m6
    ...
    800/1000 (and (road_isfree road5) (not (at ?t market3)) (at ?t market6)))))

(:action drive-m3-m6
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road5) (at ?t market3))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t market3)) (at ?t market6)))

(:action try-drive-m6-m3
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isunknown road5) (at ?t market6))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road5)) (probabilistic
    200/1000 (and (road_isblocked road5))
    800/1000 (and (road_isfree road5) (not (at ?t market6)) (at ?t market3)))))

(:action drive-m6-m3
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road5) (at ?t market6))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t market6)) (at ?t market3)))
