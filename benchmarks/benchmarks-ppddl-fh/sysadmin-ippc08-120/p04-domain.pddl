...
(:constants
  comp0 comp1 comp2 comp3 comp4 comp5 comp6 comp7 - computer
)
...
(:action evaluate-comp0-off-comp7
  :parameters ()
  :precondition (and
    (evaluate comp0)
    (not (rebooted comp0))
...
(:action evaluate-comp4-off-comp5
  :parameters ()
  :precondition (and
    (evaluate comp4)
    (not (rebooted comp4))
...
(:action evaluate-comp6-off-comp2
  :parameters ()
  :precondition (and
    (evaluate comp6)
    (not (rebooted comp6))
...
(:action evaluate-comp6-off-comp3
  :parameters ()
  :precondition (and
    (evaluate comp6)
    (not (rebooted comp6))
