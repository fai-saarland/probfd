(define (domain roverdom--s299974--m25--r2--w6--o3--c1--g4--p0--P1--Z200--X200--C10)
(:requirements :typing)
...
(:action try-navigate-l2-l5
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint2 waypoint5) (available ?x) (at ?x waypoint2) (visible waypoint2 waypoint5) (road_isunknown road8))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road8)) (probabilistic 
        ...
        800/1000 (and (road_isfree road8) (not (at ?x waypoint2)) (at ?x waypoint5))
    ))
)

(:action navigate-l2-l5
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint2 waypoint5) (available ?x) (at ?x waypoint2) (visible waypoint2 waypoint5) (road_isfree road8))
...
(:action try-navigate-l5-l2
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint5 waypoint2) (available ?x) (at ?x waypoint5) (visible waypoint5 waypoint2) (road_isunknown road8))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road8)) (probabilistic 
        200/1000 (and (road_isblocked road8))
        800/1000 (and (road_isfree road8) (not (at ?x waypoint5)) (at ?x waypoint2))
    ))
)

(:action navigate-l5-l2
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint5 waypoint2) (available ?x) (at ?x waypoint5) (visible waypoint5 waypoint2) (road_isfree road8))
