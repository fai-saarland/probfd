(define (domain roverdom--s717101--m25--r2--w6--o3--c1--g4--p0--P1--Z200--X200--C10)
(:requirements :typing)
...
(:action try-navigate-l3-l4
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint3 waypoint4) (available ?x) (at ?x waypoint3) (visible waypoint3 waypoint4) (road_isunknown road9))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road9)) (probabilistic 
        ...
        800/1000 (and (road_isfree road9) (not (at ?x waypoint3)) (at ?x waypoint4))
    ))
)

(:action navigate-l3-l4
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint3 waypoint4) (available ?x) (at ?x waypoint3) (visible waypoint3 waypoint4) (road_isfree road9))
...
(:action try-navigate-l4-l3
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint4 waypoint3) (available ?x) (at ?x waypoint4) (visible waypoint4 waypoint3) (road_isunknown road9))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road9)) (probabilistic 
        200/1000 (and (road_isblocked road9))
        800/1000 (and (road_isfree road9) (not (at ?x waypoint4)) (at ?x waypoint3))
    ))
)

(:action navigate-l4-l3
    :parameters (?hcur ?hnew - horizon-value ?x - rover)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (can_traverse ?x waypoint4 waypoint3) (available ?x) (at ?x waypoint4) (visible waypoint4 waypoint3) (road_isfree road9))
