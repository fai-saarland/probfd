(define (domain dom--tpp-m7-g4-s773243)
...
(:action try-drive-m2-m6
    ...
    800/1000 (and (road_isfree road3) (not (at ?t market2)) (at ?t market6)))))

(:action drive-m2-m6
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road3) (at ?t market2))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t market2)) (at ?t market6)))
...
(:action try-drive-m6-m2
    ...
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road3)) (probabilistic
    200/1000 (and (road_isblocked road3))
    800/1000 (and (road_isfree road3) (not (at ?t market6)) (at ?t market2)))))

(:action drive-m6-m2
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road3) (at ?t market6))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t market6)) (at ?t market2)))
...
(:action try-drive-m3-m4
    ...
    800/1000 (and (road_isfree road5) (not (at ?t market3)) (at ?t market4)))))

(:action drive-m3-m4
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road5) (at ?t market3))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t market3)) (at ?t market4)))
...
(:action try-drive-m4-m3
    ...
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road5)) (probabilistic
    200/1000 (and (road_isblocked road5))
    800/1000 (and (road_isfree road5) (not (at ?t market4)) (at ?t market3)))))

(:action drive-m4-m3
    :parameters (?hcur ?hnew - horizon-value ?t - truck)
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew) (road_isfree road5) (at ?t market4))
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (at ?t market4)) (at ?t market3)))
...
(:action try-drive-m3-m6
    ...
    800/1000 (and (road_isfree road6) (not (at ?t market3)) (at ?t market6)))))
...
(:action try-drive-m6-m3
    ...
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (road_isunknown road6)) (probabilistic
    200/1000 (and (road_isblocked road6))
    800/1000 (and (road_isfree road6) (not (at ?t market6)) (at ?t market3)))))
