;;; H=22 E=[1, 1, 20] T=[1, 1, 11] Sub=3 1-per=40 Seed=324241(2140687749857675880)
...
(:constants
    host0 host1 host2 host3 host4 host5 host6 host7 host8 host9 host10 host11 host12 host13 host14 host15 host16 host17 host18 host19 host20 host21 internet - host
    p80 p3306 p445 - port
)
