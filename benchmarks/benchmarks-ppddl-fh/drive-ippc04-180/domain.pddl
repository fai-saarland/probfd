(define (domain drive)
        ...
        (:types horizon-value - object coord direction color delay preference length rotation)
        ...
        (:action look_at_light-north-north_south
                :parameters (?hcur ?hnew - horizon-value ?x - coord ?y - coord)
        ...
        (:action proceed-short-left
                :parameters (?hcur ?hnew - horizon-value ?x ?y ?new-x ?new-y - coord ?old-heading ?new-heading - direction)
                :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew)
                                (light_color green)
                                (at ?x ?y)
                                (heading ?old-heading)
        ...
        (:action proceed-short-straight
                :parameters (?hcur ?hnew - horizon-value ?x ?y ?new-x ?new-y - coord ?heading - direction)
                :precondition (and (horizon ?hcur) (horizon-decrement ?hcur ?hnew)
                                (light_color green)
                                (at ?x ?y)
                                (heading ?heading)
