...
(define (domain rectangle-world)
  ...
  (:action move-U-safe-safe
    ...
    :effect (and (increase (total-cost) 1) (not (ypos ?y)) (ypos ?y2))
    )

  (:action move-D-safe-safe
    :parameters (?x ?y ?y2 - int)
    :precondition (and (not (dead)) (xpos ?x) (ypos ?y) (next ?y2 ?y) (safeX ?x) (not (unsafe ?x ?y)))
    :effect (and (increase (total-cost) 1) (not (ypos ?y)) (ypos ?y2))
    )
  ...
  (:action move-R-safe-safe
    ...
    :effect (and (increase (total-cost) 1) (not (xpos ?x)) (xpos ?x2))
    )

  (:action move-L-safe-safe
    :parameters (?X ?y ?x2 - int)
    :precondition (and (not (dead)) (xpos ?x) (ypos ?y) (next ?x2 ?x) (safeY ?y) (not (unsafe ?x ?y)))
    :effect (and (increase (total-cost) 1) (not (xpos ?x)) (xpos ?x2))
    )
  ...
  (:action move-U-safe-unsafe
    ...
    :effect (and (increase (total-cost) 1) (dead) (not (ypos ?y)) (ypos ?y2))
    )
  ...
  (:action move-R-safe-unsafe
    ...
    :effect (and (increase (total-cost) 1) (dead) (not (xpos ?x)) (xpos ?x2))
    )
