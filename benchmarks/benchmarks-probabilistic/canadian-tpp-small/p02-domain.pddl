(define (domain dom--tpp-m4-g4-s197122)
...
(:action try-drive-m0-m1
    ...
    :effect (and (increase (total-cost) 10) (not (road_isunknown road0)) (probabilistic
...
(:action drive-m0-m1
    ...
    :effect (and (increase (total-cost) 10) (not (at ?t depot0)) (at ?t market1)))
...
(:action drive-m1-m0
    ...
    :effect (and (increase (total-cost) 10) (not (at ?t market1)) (at ?t depot0)))
...
(:action try-drive-m4-m0
    :parameters (?t - truck)
    :precondition (and (road_isunknown road1) (at ?t market4))
    :effect (and (increase (total-cost) 6) (not (road_isunknown road1)) (probabilistic
    200/1000 (and (road_isblocked road1))
...
(:action drive-m4-m0
    :parameters (?t - truck)
    :precondition (and (road_isfree road1) (at ?t market4))
...
(:action try-drive-m1-m2
    ...
    :effect (and (increase (total-cost) 19) (not (road_isunknown road2)) (probabilistic
...
(:action drive-m1-m2
    ...
    :effect (and (increase (total-cost) 19) (not (at ?t market1)) (at ?t market2)))
...
(:action drive-m2-m1
    ...
    :effect (and (increase (total-cost) 19) (not (at ?t market2)) (at ?t market1)))
...
(:action drive-m1-m4
    ...
    :effect (and (increase (total-cost) 4) (not (at ?t market1)) (at ?t market4)))
...
(:action drive-m4-m1
    ...
    :effect (and (increase (total-cost) 4) (not (at ?t market4)) (at ?t market1)))
