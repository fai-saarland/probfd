(define (domain dom--tpp-m4-g4-s363164)
...
(:action drive-m0-m1
    ...
    :effect (and (increase (total-cost) 5) (not (at ?t depot0)) (at ?t market1)))
...
(:action drive-m1-m0
    ...
    :effect (and (increase (total-cost) 5) (not (at ?t market1)) (at ?t depot0)))

(:action try-drive-m0-m2
    :parameters (?t - truck)
    :precondition (and (road_isunknown road1) (at ?t depot0))
    :effect (and (increase (total-cost) 23) (not (road_isunknown road1)) (probabilistic
...
(:action drive-m0-m2
    ...
    :effect (and (increase (total-cost) 23) (not (at ?t depot0)) (at ?t market2)))
...
(:action drive-m2-m0
    ...
    :effect (and (increase (total-cost) 23) (not (at ?t market2)) (at ?t depot0)))
...
(:action try-drive-m0-m3
    ...
    800/1000 (and (road_isfree road2) (not (at ?t depot0)) (at ?t market3)))))

(:action drive-m0-m3
    :parameters (?t - truck)
    :precondition (and (road_isfree road2) (at ?t depot0))
    :effect (and (increase (total-cost) 2) (not (at ?t depot0)) (at ?t market3)))
...
(:action try-drive-m3-m0
    ...
    :effect (and (increase (total-cost) 2) (not (road_isunknown road2)) (probabilistic
    200/1000 (and (road_isblocked road2))
    800/1000 (and (road_isfree road2) (not (at ?t market3)) (at ?t depot0)))))

(:action drive-m3-m0
    :parameters (?t - truck)
    :precondition (and (road_isfree road2) (at ?t market3))
    :effect (and (increase (total-cost) 2) (not (at ?t market3)) (at ?t depot0)))

(:action try-drive-m1-m3
    :parameters (?t - truck)
    :precondition (and (road_isunknown road3) (at ?t market1))
    :effect (and (increase (total-cost) 12) (not (road_isunknown road3)) (probabilistic
    200/1000 (and (road_isblocked road3))
    800/1000 (and (road_isfree road3) (not (at ?t market1)) (at ?t market3)))))

(:action drive-m1-m3
    :parameters (?t - truck)
    :precondition (and (road_isfree road3) (at ?t market1))
    :effect (and (increase (total-cost) 12) (not (at ?t market1)) (at ?t market3)))

(:action try-drive-m3-m1
    :parameters (?t - truck)
    :precondition (and (road_isunknown road3) (at ?t market3))
    :effect (and (increase (total-cost) 12) (not (road_isunknown road3)) (probabilistic
    200/1000 (and (road_isblocked road3))
    800/1000 (and (road_isfree road3) (not (at ?t market3)) (at ?t market1)))))

(:action drive-m3-m1
    :parameters (?t - truck)
    :precondition (and (road_isfree road3) (at ?t market3))
    :effect (and (increase (total-cost) 12) (not (at ?t market3)) (at ?t market1)))

(:action try-drive-m2-m4
    :parameters (?t - truck)
    :precondition (and (road_isunknown road4) (at ?t market2))
    :effect (and (increase (total-cost) 11) (not (road_isunknown road4)) (probabilistic
    200/1000 (and (road_isblocked road4))
    800/1000 (and (road_isfree road4) (not (at ?t market2)) (at ?t market4)))))

(:action drive-m2-m4
    :parameters (?t - truck)
    :precondition (and (road_isfree road4) (at ?t market2))
    :effect (and (increase (total-cost) 11) (not (at ?t market2)) (at ?t market4)))
...
(:action drive-m4-m2
    ...
    :effect (and (increase (total-cost) 11) (not (at ?t market4)) (at ?t market2)))
