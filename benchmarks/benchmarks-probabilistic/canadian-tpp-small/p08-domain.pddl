(define (domain dom--tpp-m4-g4-s487533)
...
(:action try-drive-m0-m1
    ...
    :effect (and (increase (total-cost) 13) (not (road_isunknown road0)) (probabilistic
...
(:action drive-m0-m1
    ...
    :effect (and (increase (total-cost) 13) (not (at ?t depot0)) (at ?t market1)))
...
(:action drive-m1-m0
    ...
    :effect (and (increase (total-cost) 13) (not (at ?t market1)) (at ?t depot0)))
...
(:action drive-m0-m2
    ...
    :effect (and (increase (total-cost) 20) (not (at ?t depot0)) (at ?t market2)))
...
(:action drive-m2-m0
    ...
    :effect (and (increase (total-cost) 20) (not (at ?t market2)) (at ?t depot0)))
...
(:action drive-m2-m3
    ...
    :effect (and (increase (total-cost) 19) (not (at ?t market2)) (at ?t market3)))
...
(:action drive-m3-m2
    ...
    :effect (and (increase (total-cost) 19) (not (at ?t market3)) (at ?t market2)))
...
(:action drive-m2-m4
    ...
    :effect (and (increase (total-cost) 2) (not (at ?t market2)) (at ?t market4)))
...
(:action drive-m4-m2
    ...
    :effect (and (increase (total-cost) 2) (not (at ?t market4)) (at ?t market2)))
