(define (domain dom--tpp-m4-g4-s315981)
...
(:action try-drive-m0-m1
    ...
    :effect (and (increase (total-cost) 18) (not (road_isunknown road0)) (probabilistic
...
(:action drive-m0-m1
    ...
    :effect (and (increase (total-cost) 18) (not (at ?t depot0)) (at ?t market1)))
...
(:action drive-m1-m0
    ...
    :effect (and (increase (total-cost) 18) (not (at ?t market1)) (at ?t depot0)))

(:action try-drive-m0-m2
    :parameters (?t - truck)
    :precondition (and (road_isunknown road1) (at ?t depot0))
    :effect (and (increase (total-cost) 21) (not (road_isunknown road1)) (probabilistic
...
(:action drive-m0-m2
    ...
    :effect (and (increase (total-cost) 21) (not (at ?t depot0)) (at ?t market2)))
...
(:action drive-m2-m0
    ...
    :effect (and (increase (total-cost) 21) (not (at ?t market2)) (at ?t depot0)))
...
(:action drive-m0-m3
    ...
    :effect (and (increase (total-cost) 6) (not (at ?t depot0)) (at ?t market3)))
...
(:action drive-m3-m0
    ...
    :effect (and (increase (total-cost) 6) (not (at ?t market3)) (at ?t depot0)))

(:action try-drive-m1-m4
    :parameters (?t - truck)
    :precondition (and (road_isunknown road3) (at ?t market1))
    :effect (and (increase (total-cost) 8) (not (road_isunknown road3)) (probabilistic
...
(:action drive-m1-m4
    ...
    :effect (and (increase (total-cost) 8) (not (at ?t market1)) (at ?t market4)))
...
(:action drive-m4-m1
    ...
    :effect (and (increase (total-cost) 8) (not (at ?t market4)) (at ?t market1)))

(:action try-drive-m2-m3
    :parameters (?t - truck)
    :precondition (and (road_isunknown road4) (at ?t market2))
    :effect (and (increase (total-cost) 2) (not (road_isunknown road4)) (probabilistic
...
(:action drive-m2-m3
    ...
    :effect (and (increase (total-cost) 2) (not (at ?t market2)) (at ?t market3)))
...
(:action drive-m3-m2
    ...
    :effect (and (increase (total-cost) 2) (not (at ?t market3)) (at ?t market2)))
