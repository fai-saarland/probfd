(define (domain a-schedule-problem412)
...
(:action process-arrivals-C0
  ...
  :effect (and
    ...
    (probabilistic 3/50 (and (not (available ?arriving-packet)) (time-to-live ?arriving-packet ?t) (packet-class ?arriving-packet C0)))
