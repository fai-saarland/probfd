(define (domain canadian-transport-l4-e8-t1-p5--minP200--maxP200--s223535)
...
(:action try-driving-l0-l1
    ...
    :effect (and (increase (total-cost) 21) (not (road-status r0 unknown))
    (probabilistic
...
(:action drive-l0-l1
    ...
    :effect (and (increase (total-cost) 21) (at l1) (not (at l0)))
)
...
(:action drive-l1-l0
    ...
    :effect (and (increase (total-cost) 21) (at l0) (not (at l1)))
)
(:action try-driving-l0-l2
    :precondition (and (at l0) (road-status r1 unknown))
    :effect (and (increase (total-cost) 18) (not (road-status r1 unknown))
    (probabilistic
...
(:action drive-l0-l2
    ...
    :effect (and (increase (total-cost) 18) (at l2) (not (at l0)))
)
...
(:action drive-l2-l0
    ...
    :effect (and (increase (total-cost) 18) (at l0) (not (at l2)))
)
(:action try-driving-l0-l3
    :precondition (and (at l0) (road-status r2 unknown))
    :effect (and (increase (total-cost) 4) (not (road-status r2 unknown))
    (probabilistic
...
(:action drive-l0-l3
    ...
    :effect (and (increase (total-cost) 4) (at l3) (not (at l0)))
)
...
(:action drive-l3-l0
    ...
    :effect (and (increase (total-cost) 4) (at l0) (not (at l3)))
)
(:action try-driving-l1-l2
    :precondition (and (at l1) (road-status r3 unknown))
    :effect (and (increase (total-cost) 17) (not (road-status r3 unknown))
    (probabilistic
...
(:action drive-l1-l2
    ...
    :effect (and (increase (total-cost) 17) (at l2) (not (at l1)))
)
...
(:action drive-l2-l1
    ...
    :effect (and (increase (total-cost) 17) (at l1) (not (at l2)))
)
(:action try-driving-l1-l3
    :precondition (and (at l1) (road-status r4 unknown))
    :effect (and (increase (total-cost) 16) (not (road-status r4 unknown))
    (probabilistic
...
(:action drive-l1-l3
    ...
    :effect (and (increase (total-cost) 16) (at l3) (not (at l1)))
)
...
(:action drive-l3-l1
    ...
    :effect (and (increase (total-cost) 16) (at l1) (not (at l3)))
)
...
(:action drive-l2-l3
    ...
    :effect (and (increase (total-cost) 5) (at l3) (not (at l2)))
)
...
(:action drive-l3-l2
    ...
    :effect (and (increase (total-cost) 5) (at l2) (not (at l3)))
)
)
