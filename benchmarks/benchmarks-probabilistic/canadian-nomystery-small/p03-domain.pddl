...
(:action try-driving-l0-l1
    ...
    :effect (and (increase (total-cost) 4) (not (road-status r0 unknown))
    (probabilistic
...
(:action drive-l0-l1
    ...
    :effect (and (increase (total-cost) 4) (at l1) (not (at l0)))
)
...
(:action drive-l1-l0
    ...
    :effect (and (increase (total-cost) 4) (at l0) (not (at l1)))
)
...
(:action try-driving-l1-l2
    ...
    :effect (and (increase (total-cost) 6) (not (road-status r3 unknown))
    (probabilistic
...
(:action drive-l1-l2
    ...
    :effect (and (increase (total-cost) 6) (at l2) (not (at l1)))
)
...
(:action drive-l2-l1
    ...
    :effect (and (increase (total-cost) 6) (at l1) (not (at l2)))
)
(:action try-driving-l1-l3
    :precondition (and (at l1) (road-status r4 unknown))
    :effect (and (increase (total-cost) 10) (not (road-status r4 unknown))
    (probabilistic
...
(:action drive-l1-l3
    ...
    :effect (and (increase (total-cost) 10) (at l3) (not (at l1)))
)
...
(:action drive-l3-l1
    ...
    :effect (and (increase (total-cost) 10) (at l1) (not (at l3)))
)
(:action try-driving-l2-l3
    :precondition (and (at l2) (road-status r5 unknown))
    :effect (and (increase (total-cost) 16) (not (road-status r5 unknown))
    (probabilistic
...
(:action drive-l2-l3
    ...
    :effect (and (increase (total-cost) 16) (at l3) (not (at l2)))
)
...
(:action drive-l3-l2
    ...
    :effect (and (increase (total-cost) 16) (at l2) (not (at l3)))
)
)
