...
(:constants
  comp0 comp1 comp2 comp3 comp4 comp5 comp6 comp7 comp8 comp9 comp10 comp11 comp12 comp13 comp14 comp15 comp16 comp17 comp18 comp19 - computer
)
(:predicates
  (running ?c - computer)
  (rebooted ?c - computer)
...
(:action evaluate-comp2-off-comp5
  :parameters ()
  :precondition (and
    (evaluate comp2)
    (not (rebooted comp2))
...
(:action evaluate-comp2-off-comp18
  :parameters ()
  :precondition (and
    (evaluate comp2)
    (not (rebooted comp2))
...
(:action evaluate-comp5-off-comp11
  :parameters ()
  :precondition (and
    (evaluate comp5)
    (not (rebooted comp5))
...
(:action evaluate-comp9-off-comp6
  :parameters ()
  :precondition (and
    (evaluate comp9)
    (not (rebooted comp9))
...
(:action evaluate-comp13-off-comp5
  :parameters ()
  :precondition (and
    (evaluate comp13)
    (not (rebooted comp13))
...
(:action evaluate-comp14-off-comp17
  :parameters ()
  :precondition (and
    (evaluate comp14)
    (not (rebooted comp14))
...
(:action evaluate-comp14-off-comp19
  :parameters ()
  :precondition (and
    (evaluate comp14)
    (not (rebooted comp14))
...
(:action evaluate-comp18-off-comp15
  :parameters ()
  :precondition (and
    (evaluate comp18)
    (not (rebooted comp18))
