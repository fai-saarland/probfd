...
(:action try-driving-l0-l1
    ...
    :effect (and (increase (total-cost) 23) (not (road-status r0 unknown))
    (probabilistic
...
(:action drive-l0-l1
    ...
    :effect (and (increase (total-cost) 23) (at l1) (not (at l0)))
)
...
(:action drive-l1-l0
    ...
    :effect (and (increase (total-cost) 23) (at l0) (not (at l1)))
)
(:action try-driving-l0-l2
    :precondition (and (at l0) (road-status r1 unknown))
    :effect (and (increase (total-cost) 24) (not (road-status r1 unknown))
    (probabilistic
...
(:action drive-l0-l2
    ...
    :effect (and (increase (total-cost) 24) (at l2) (not (at l0)))
)
...
(:action drive-l2-l0
    ...
    :effect (and (increase (total-cost) 24) (at l0) (not (at l2)))
)
(:action try-driving-l0-l3
    :precondition (and (at l0) (road-status r2 unknown))
    :effect (and (increase (total-cost) 11) (not (road-status r2 unknown))
    (probabilistic
...
(:action drive-l0-l3
    ...
    :effect (and (increase (total-cost) 11) (at l3) (not (at l0)))
)
...
(:action drive-l3-l0
    ...
    :effect (and (increase (total-cost) 11) (at l0) (not (at l3)))
)
...
(:action try-driving-l1-l3
    ...
    :effect (and (increase (total-cost) 14) (not (road-status r5 unknown))
    (probabilistic
...
(:action drive-l1-l3
    ...
    :effect (and (increase (total-cost) 14) (at l3) (not (at l1)))
)
...
(:action drive-l3-l1
    ...
    :effect (and (increase (total-cost) 14) (at l1) (not (at l3)))
)
(:action try-driving-l1-l4
    :precondition (and (at l1) (road-status r6 unknown))
    :effect (and (increase (total-cost) 18) (not (road-status r6 unknown))
    (probabilistic
...
(:action drive-l1-l4
    ...
    :effect (and (increase (total-cost) 18) (at l4) (not (at l1)))
)
...
(:action drive-l4-l1
    ...
    :effect (and (increase (total-cost) 18) (at l1) (not (at l4)))
)
(:action try-driving-l2-l3
    :precondition (and (at l2) (road-status r7 unknown))
    :effect (and (increase (total-cost) 1) (not (road-status r7 unknown))
    (probabilistic
...
(:action drive-l2-l3
    ...
    :effect (and (increase (total-cost) 1) (at l3) (not (at l2)))
)
...
(:action drive-l3-l2
    ...
    :effect (and (increase (total-cost) 1) (at l2) (not (at l3)))
)
(:action try-driving-l2-l4
    :precondition (and (at l2) (road-status r8 unknown))
    :effect (and (increase (total-cost) 22) (not (road-status r8 unknown))
    (probabilistic
...
(:action drive-l2-l4
    ...
    :effect (and (increase (total-cost) 22) (at l4) (not (at l2)))
)
...
(:action drive-l4-l2
    ...
    :effect (and (increase (total-cost) 22) (at l2) (not (at l4)))
)
(:action try-driving-l3-l4
    :precondition (and (at l3) (road-status r9 unknown))
    :effect (and (increase (total-cost) 12) (not (road-status r9 unknown))
    (probabilistic
...
(:action drive-l3-l4
    ...
    :effect (and (increase (total-cost) 12) (at l4) (not (at l3)))
)
...
(:action drive-l4-l3
    ...
    :effect (and (increase (total-cost) 12) (at l3) (not (at l4)))
)
)
