(define (domain canadian-transport-l4-e8-t1-p5--minP200--maxP200--s964115)
...
(:action try-driving-l0-l3
    ...
    :effect (and (increase (total-cost) 24) (not (road-status r2 unknown))
    (probabilistic
...
(:action drive-l0-l3
    ...
    :effect (and (increase (total-cost) 24) (at l3) (not (at l0)))
)
...
(:action drive-l3-l0
    ...
    :effect (and (increase (total-cost) 24) (at l0) (not (at l3)))
)
(:action try-driving-l1-l2
    :precondition (and (at l1) (road-status r3 unknown))
    :effect (and (increase (total-cost) 25) (not (road-status r3 unknown))
    (probabilistic
...
(:action drive-l1-l3
    ...
    :effect (and (increase (total-cost) 15) (at l3) (not (at l1)))
)
...
(:action drive-l3-l1
    ...
    :effect (and (increase (total-cost) 15) (at l1) (not (at l3)))
)
(:action try-driving-l2-l3
    :precondition (and (at l2) (road-status r5 unknown))
    :effect (and (increase (total-cost) 11) (not (road-status r5 unknown))
    (probabilistic
...
(:action drive-l2-l3
    ...
    :effect (and (increase (total-cost) 11) (at l3) (not (at l2)))
)
...
(:action drive-l3-l2
    ...
    :effect (and (increase (total-cost) 11) (at l2) (not (at l3)))
)
)
