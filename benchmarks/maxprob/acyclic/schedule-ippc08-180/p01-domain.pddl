(define
  ...
  (:constants horzn1 - horizon-value  C0 - class Arrivals-and-updating Cleanup-and-service - phase U0 U1 U2 U3 U4 - timestep P0 P1 P2 P3 - packet)
  ...
  (:action process-arrivals-C0
    ...
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (need-to-process-arrivals C0)) (probabilistic 1/10 (and (not (available ?arriving-packet)) (time-to-live ?arriving-packet ?t) (packet-class ?arriving-packet C0))))
  )
  (:action time-update
  ...
  (:action packet-serve
    ...
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur horzn1 ?hnew) (current-phase Cleanup-and-service) (packet-class ?p ?c) (current-timestep ?t) (not (time-to-live P0 ?t)) (not (time-to-live P1 ?t)) (not (time-to-live P2 ?t)) (not (time-to-live P3 ?t)))
  ...
  (:action serve-nothing
    ...
    :precondition (and (horizon ?hcur) (horizon-decrement ?hcur horzn1 ?hnew) (current-phase Cleanup-and-service) (current-timestep ?t) (not (time-to-live P0 ?t)) (not (time-to-live P1 ?t)) (not (time-to-live P2 ?t)) (not (time-to-live P3 ?t)))
