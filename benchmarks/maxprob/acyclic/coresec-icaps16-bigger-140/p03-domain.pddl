(define
  ...
  (:constants horzn1 horzn2 horzn3 horzn4 horzn5 horzn10 - horizon-value  host0 host1 host2 host3 host4 host5 host6 host7 host8 host9 host10 host11 internet - host p80 p3306 p445 - port)
