(define
  ...
  (:action process-arrivals-C0
    ...
    :effect (and (not (horizon ?hcur)) (horizon ?hnew) (increase (total-cost) 1) (not (need-to-process-arrivals C0)) (probabilistic 3/50 (and (not (available ?arriving-packet)) (time-to-live ?arriving-packet ?t) (packet-class ?arriving-packet C0))))
  )
  (:action time-update
