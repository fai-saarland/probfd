(define
  ...
  (:constants host0 host1 host2 host3 host4 host5 host6 host7 host8 host9 host10 host11 host12 host13 host14 host15 host16 host17 host18 host19 host20 host21 host22 host23 internet - host p80 p3306 p445 - port)
  ...
  (:action ex-host11_winNT4ser_IIS4_vuln63
    :parameters (?src - host)
    :precondition (and (hacl ?src host11 p80) (controlling ?src) (expl_host11_winNT4ser_IIS4_vuln63))
    :effect (and (increase (total-cost) 5) (not (expl_host11_winNT4ser_IIS4_vuln63)) (probabilistic 78/100 (and (controlling host11))))
  )
  (:action ex-host12_win2000adv_SQL5_vuln64
    :parameters (?src - host)
    :precondition (and (hacl ?src host12 p3306) (controlling ?src) (expl_host12_win2000adv_SQL5_vuln64))
    :effect (and (increase (total-cost) 1) (not (expl_host12_win2000adv_SQL5_vuln64)) (probabilistic 73/100 (and (controlling host12))))
  )
  ...
  (:action ex-host22_winNT4ent_IIS4_vuln57
    :parameters (?src - host)
    :precondition (and (hacl ?src host22 p80) (controlling ?src) (expl_host22_winNT4ent_IIS4_vuln57))
    :effect (and (increase (total-cost) 1) (not (expl_host22_winNT4ent_IIS4_vuln57)) (probabilistic 79/100 (and (controlling host22))))
  )
  (:action ex-host22_winNT4ser_IIS4_vuln63
    :parameters (?src - host)
    :precondition (and (hacl ?src host22 p80) (controlling ?src) (expl_host22_winNT4ser_IIS4_vuln63))
    :effect (and (increase (total-cost) 5) (not (expl_host22_winNT4ser_IIS4_vuln63)) (probabilistic 78/100 (and (controlling host22))))
  )
  (:action ex-host23_win2000adv_SQL5_vuln64
    :parameters (?src - host)
    :precondition (and (hacl ?src host23 p3306) (controlling ?src) (expl_host23_win2000adv_SQL5_vuln64))
    :effect (and (increase (total-cost) 1) (not (expl_host23_win2000adv_SQL5_vuln64)) (probabilistic 73/100 (and (controlling host23))))
  )
  (:action ex-host23_winNT4ent_SQL4_vuln42
    :parameters (?src - host)
    :precondition (and (hacl ?src host23 p3306) (controlling ?src) (expl_host23_winNT4ent_SQL4_vuln42))
    :effect (and (increase (total-cost) 2) (not (expl_host23_winNT4ent_SQL4_vuln42)) (probabilistic 65/100 (and (controlling host23))))
  )
)