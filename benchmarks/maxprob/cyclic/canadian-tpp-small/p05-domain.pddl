(define (domain dom--tpp-m4-g4-s319860)
...
(:action try-drive-m0-m3
    ...
    :effect (and (increase (total-cost) 3) (not (road_isunknown road1)) (probabilistic
...
(:action drive-m0-m3
    ...
    :effect (and (increase (total-cost) 3) (not (at ?t depot0)) (at ?t market3)))
...
(:action drive-m3-m0
    ...
    :effect (and (increase (total-cost) 3) (not (at ?t market3)) (at ?t depot0)))
...
(:action drive-m0-m4
    ...
    :effect (and (increase (total-cost) 22) (not (at ?t depot0)) (at ?t market4)))
...
(:action drive-m4-m0
    ...
    :effect (and (increase (total-cost) 22) (not (at ?t market4)) (at ?t depot0)))

(:action try-drive-m2-m4
    :parameters (?t - truck)
    :precondition (and (road_isunknown road3) (at ?t market2))
    :effect (and (increase (total-cost) 19) (not (road_isunknown road3)) (probabilistic
...
(:action drive-m2-m4
    ...
    :effect (and (increase (total-cost) 19) (not (at ?t market2)) (at ?t market4)))
...
(:action drive-m4-m2
    ...
    :effect (and (increase (total-cost) 19) (not (at ?t market4)) (at ?t market2)))
...
(:action drive-m3-m4
    ...
    :effect (and (increase (total-cost) 22) (not (at ?t market3)) (at ?t market4)))
...
(:action drive-m4-m3
    ...
    :effect (and (increase (total-cost) 22) (not (at ?t market4)) (at ?t market3)))
