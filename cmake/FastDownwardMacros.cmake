...
macro(fast_downward_set_compiler_flags)
    ...
    if(${CMAKE_CXX_COMPILER_ID} MATCHES "Clang|GNU")
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -g -Wall -Wextra -pedantic -Wnon-virtual-dtor -Wfloat-conversion")
        ...
        if(${CMAKE_CXX_COMPILER_ID} MATCHES "Clang")
            ...
            # User-defined libc++ std library path
            if(DEFINED ENV{LIBCXX_INCLUDE})
                set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -stdlib=libc++ -I$ENV{LIBCXX_INCLUDE}")         
            endif()
        endif()
