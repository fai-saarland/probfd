...
function(add_existing_test_sources_to_list _HEADERS_LIST_VAR _SOURCES_LIST_VAR)
    ...
    foreach(SOURCE_FILE ${${_SOURCES_LIST_VAR}})
        ...
        if (EXISTS "${PROJECT_SOURCE_DIR}/tests/${_SOURCE_FILE_DIR}${_SOURCE_FILE_NAME}.h")
            list(APPEND _HEADER_FILES "${PROJECT_SOURCE_DIR}/tests/${_SOURCE_FILE_DIR}${_SOURCE_FILE_NAME}.h")
        endif()
        if (EXISTS "${PROJECT_SOURCE_DIR}/tests/${_SOURCE_FILE_DIR}${_SOURCE_FILE_NAME}.cc")
            list(APPEND _SOURCE_FILES "${PROJECT_SOURCE_DIR}/tests/${_SOURCE_FILE_DIR}${_SOURCE_FILE_NAME}.cc")
        endif()
    endforeach()
    set(${_HEADERS_LIST_VAR} ${_HEADER_FILES} PARENT_SCOPE)
    set(${_SOURCES_LIST_VAR} ${_SOURCE_FILES} PARENT_SCOPE)
