...
function(add_existing_sources_to_list _SOURCES_LIST_VAR)
    ...
    foreach(SOURCE_FILE ${${_SOURCES_LIST_VAR}})
        ...
        if (EXISTS "${PROJECT_SOURCE_DIR}/include/search/${_SOURCE_FILE_DIR}${_SOURCE_FILE_NAME}.h")
            list(APPEND _ALL_FILES "${PROJECT_SOURCE_DIR}/include/search/${_SOURCE_FILE_DIR}${_SOURCE_FILE_NAME}.h")
        endif()
        if (EXISTS "${PROJECT_SOURCE_DIR}/src/search/${_SOURCE_FILE_DIR}${_SOURCE_FILE_NAME}.cc")
            list(APPEND _ALL_FILES "${PROJECT_SOURCE_DIR}/src/search/${_SOURCE_FILE_DIR}${_SOURCE_FILE_NAME}.cc")
        endif()
    endforeach()
...
function(copy_dlls_to_binary_dir_after_build _TARGET_NAME)
    if($<TARGET_RUNTIME_DLLS:${_TARGET_NAME}>)
