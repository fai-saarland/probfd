create_library(
    ...
    SOURCES
    downward_cli/tasks/task_transformation_category
    DEPENDS
        plugins
        core_sources
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/mutexes/mutex_factory_category
    DEPENDS
        plugins
        core_sources
    TARGET
...
create_library(
    NAME from_file_mutex_factory_feature
    HELP "Mutex factory that reads them from a file plugin"
    SOURCES
    downward_cli/mutexes/from_file_mutex_factory_feature
    DEPENDS
        plugins
...
create_library(
    ...
    SOURCES
    downward_cli/evaluators/evaluator_category
    DEPENDS
        plugins
        core_sources
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/evaluators/evaluator_options
    DEPENDS
        plugins
        logging_options
        utils
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/heuristic_options
    DEPENDS
        plugins
        evaluator_options
        utils
...
create_library(
    ...
    SOURCES
    downward_cli/open_lists/open_list_factory_category
    DEPENDS
        plugins
        core_sources
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/open_lists/open_list_options
    DEPENDS
        plugins
)
...
create_library(
    ...
    SOURCES
    downward_cli/operator_cost_category
    DEPENDS
        plugins
        core_sources
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/operator_cost_options
    DEPENDS
        plugins
        core_sources
...
create_library(
    ...
    SOURCES
    downward_cli/pruning/pruning_method_category
    DEPENDS
        plugins
        core_sources
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/pruning/pruning_method_options
    DEPENDS
        plugins
        utils
        logging_options
...
create_library(
    ...
    SOURCES
    downward_cli/search_algorithms/search_algorithm_factory_category
    DEPENDS
        plugins
        core_sources
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/search_algorithms/search_algorithm_options
    DEPENDS
        plugins
...
create_library(
    ...
    SOURCES
    downward_cli/open_lists/alternation_open_list_feature
    DEPENDS
        plugins
    TARGET
        probfd
...
create_library(
    ...
    SOURCES
    downward_cli/open_lists/best_first_open_list_feature
    DEPENDS
        plugins
        open_list_options
        utils
...
create_library(
    ...
    SOURCES
    downward_cli/open_lists/epsilon_greedy_open_list_feature
    DEPENDS
        plugins
        open_list_options
        rng_options
...
create_library(
    ...
    SOURCES
    downward_cli/open_lists/pareto_open_list_feature
    DEPENDS
        plugins
        open_list_options
        rng_options
...
create_library(
    ...
    SOURCES
    downward_cli/open_lists/tiebreaking_open_list_feature
    DEPENDS
        plugins
        open_list_options
        utils
...
create_library(
    ...
    SOURCES
    downward_cli/open_lists/type_based_open_list_feature
    DEPENDS
        plugins
        open_list_options
        rng_options
...
create_library(
    ...
    SOURCES
    downward_cli/evaluators/subcategory
    DEPENDS
        plugins
    TARGET
        probfd
...
create_library(
    ...
    SOURCES
    downward_cli/evaluators/combining_evaluator_options
    DEPENDS
        plugins
        evaluator_options
        utils
...
create_library(
    ...
    SOURCES
    downward_cli/evaluators/const_evaluator_feature
    DEPENDS
        plugins
        evaluator_options
        const_evaluator
...
create_library(
    ...
    SOURCES
    downward_cli/evaluators/g_evaluator_feature
    DEPENDS
        plugins
        evaluator_options
        g_evaluator
...
create_library(
    ...
    SOURCES
    downward_cli/evaluators/max_evaluator_feature
    DEPENDS
        plugins
...
create_library(
    ...
    SOURCES
    downward_cli/evaluators/pref_evaluator_feature
    DEPENDS
        plugins
        evaluator_options
        pref_evaluator
...
create_library(
    ...
    SOURCES
    downward_cli/evaluators/sum_evaluator_feature
    DEPENDS
        plugins
        combining_evaluator_options
        sum_evaluator
...
create_library(
    ...
    SOURCES
    downward_cli/evaluators/weighted_evaluator_feature
    DEPENDS
        plugins
        evaluator_options
        weighted_evaluator
...
create_library(
    ...
    SOURCES
    downward_cli/pruning/null_pruning_method_feature
    DEPENDS
        plugins
...
create_library(
    ...
    SOURCES
    downward_cli/pruning/limited_pruning_feature
    DEPENDS
        plugins
        pruning_method_options
        limited_pruning
...
create_library(
    ...
    SOURCES
    downward_cli/pruning/stubborn_sets_atom_centric_feature
    DEPENDS
        plugins
        pruning_method_options
...
create_library(
    ...
    SOURCES
    downward_cli/pruning/stubborn_sets_simple_feature
    DEPENDS
        plugins
        pruning_method_options
...
create_library(
    ...
    SOURCES
    downward_cli/pruning/stubborn_sets_ec_feature
    DEPENDS
        plugins
        pruning_method_options
        stubborn_sets_ec
...
create_library(
    ...
    SOURCES
    downward_cli/search_algorithms/eager_search_options
    DEPENDS
        plugins
...
create_library(
    ...
    SOURCES
    downward_cli/search_algorithms/astar_feature
    DEPENDS
        plugins
...
create_library(
    ...
    SOURCES
    downward_cli/search_algorithms/eager_feature
    DEPENDS
        plugins
        eager_search_options
        eager_search
...
create_library(
    ...
    SOURCES
    downward_cli/search_algorithms/eager_greedy_feature
    DEPENDS
        plugins
        eager_search_options
        eager_search
...
create_library(
    ...
    SOURCES
    downward_cli/search_algorithms/eager_wastar_feature
    DEPENDS
        plugins
        eager_search_options
        eager_search
...
create_library(
    ...
    SOURCES
    downward_cli/search_algorithms/lazy_feature
    DEPENDS
        plugins
        search_algorithm_options
        lazy_search
...
create_library(
    ...
    SOURCES
    downward_cli/search_algorithms/lazy_greedy_feature
    DEPENDS
        plugins
        search_algorithm_options
        lazy_search
...
create_library(
    ...
    SOURCES
    downward_cli/search_algorithms/lazy_wastar_feature
    DEPENDS
        plugins
        search_algorithm_options
        lazy_search
...
create_library(
    ...
    SOURCES
    downward_cli/search_algorithms/enforced_hill_climbing_search_feature
    DEPENDS
        plugins
        search_algorithm_options
...
create_library(
    ...
    SOURCES
    downward_cli/search_algorithms/iterated_search_feature
    DEPENDS
        plugins
        search_algorithm_options
        iterated_search
...
create_library(
    ...
    SOURCES
    downward_cli/lp/lp_solver_enum
    DEPENDS
        plugins
        lp_solver
)
...
create_library(
    ...
    HELP "LP solver options"
    SOURCES
    downward_cli/lp/lp_solver_options
    DEPENDS
        plugins
        lp_solver_enum
)
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/additive_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
        additive_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/blind_search_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/cea_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/cg_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
        cg_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/ff_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
        ff_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/goal_count_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/hm_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
        hm_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/lm_cut_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/max_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
        max_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/tasks/cost_task_transformation_feature
    DEPENDS
        plugins
        operator_cost_options
        core_sources
...
create_library(
    ...
    SOURCES
    downward_cli/tasks/identity_task_transformation_feature
    DEPENDS
        plugins
        core_sources
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/operator_counting/constraint_generator_category
    DEPENDS
        plugins
        operator_counting
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/operator_counting/delete_relaxation_if_constraints_feature
    DEPENDS
        plugins
        operator_counting
        lp_solver
...
create_library(
    ...
    SOURCES
    downward_cli/operator_counting/delete_relaxation_rr_constraints_feature
    DEPENDS
        plugins
        operator_counting
        lp_solver
...
create_library(
    ...
    SOURCES
    downward_cli/operator_counting/lm_cut_constraints_feature
    DEPENDS
        plugins
        operator_counting
        utils
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/operator_counting_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
        lp_solver_options
...
create_library(
    ...
    SOURCES
    downward_cli/operator_counting/pho_constraints_feature
    DEPENDS
        plugins
        operator_counting
        utils
...
create_library(
    ...
    SOURCES
    downward_cli/operator_counting/state_equation_constraints_feature
    DEPENDS
        plugins
        logging_options
        operator_counting
...
create_library(
    ...
    SOURCES
    downward_cli/utils/verbosity_enum
    DEPENDS
        plugins
        utils
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/utils/logging_options
    DEPENDS
        plugins
        utils
        verbosity_enum
...
create_library(
    ...
    HELP "RNG options"
    SOURCES
    downward_cli/utils/rng_options
    DEPENDS
        plugins
)
...
create_library(
    ...
    SOURCES
    downward_cli/potentials/subcategory
    DEPENDS
        plugins
    TARGET
        probfd
...
create_library(
    ...
    SOURCES
    downward_cli/potentials/potential_options
    DEPENDS
        plugins
        heuristic_options
        lp_solver_options
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/diverse_potential_heuristics_feature
    DEPENDS
        plugins
        potential_options
        rng_options
...
create_library(
    ...
    HELP "Sample-based potential heuristics feature"
    SOURCES
    downward_cli/heuristics/sample_based_potential_heuristics_feature
    DEPENDS
        plugins
        potential_options
        rng_options
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/single_potential_heuristics_feature
    DEPENDS
        plugins
        potential_options
        potentials
...
create_library(
    ...
    SOURCES
    downward_cli/cartesian_abstractions/subtask_generators_category
    DEPENDS
        plugins
...
create_library(
    ...
    SOURCES
    downward_cli/cartesian_abstractions/subtask_generators_feature
    DEPENDS
        plugins
        rng_options
        cartesian_abstractions
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/additive_cartesian_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
        rng_options
...
create_library(
    ...
    SOURCES
    downward_cli/landmarks/landmark_heuristic_options
    DEPENDS
        plugins
        heuristic_options
        landmarks
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/landmark_cost_partitioning_heuristic_feature
    DEPENDS
        plugins
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/landmark_sum_heuristic_feature
    DEPENDS
        plugins
        landmark_heuristic_options
        landmarks
...
create_library(
    ...
    SOURCES
    downward_cli/landmarks/landmark_factory_category
    DEPENDS
        plugins
        logging_options
        landmarks
...
create_library(
    ...
    HELP "Landmark factory options"
    SOURCES
    downward_cli/landmarks/landmark_factory_options
    DEPENDS
        plugins
        logging_options
...
create_library(
    ...
    HELP "Landmark factory options"
    SOURCES
    downward_cli/landmarks/landmark_factory_h_m_feature
    DEPENDS
        plugins
...
create_library(
    ...
    HELP "Landmark factory options"
    SOURCES
    downward_cli/landmarks/landmark_factory_merged_feature
    DEPENDS
        plugins
        landmark_factory_options
        landmarks
...
create_library(
    ...
    HELP "Landmark factory options"
    SOURCES
    downward_cli/landmarks/landmark_factory_reasonable_orders_hps_feature
    DEPENDS
        plugins
        landmark_factory_options
        landmarks
...
create_library(
    ...
    HELP "Landmark factory options"
    SOURCES
    downward_cli/landmarks/landmark_factory_rpg_exhaust_feature
    DEPENDS
        plugins
        landmark_factory_options
        landmarks
...
create_library(
    ...
    HELP "Landmark factory options"
    SOURCES
    downward_cli/landmarks/landmark_factory_rpg_sasp_feature
    DEPENDS
        plugins
        landmark_factory_options
        landmarks
...
create_library(
    ...
    HELP "Landmark factory options"
    SOURCES
    downward_cli/landmarks/landmark_factory_zhu_givan_feature
    DEPENDS
        plugins
        landmark_factory_options
        landmarks
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/label_reduction_feature
    DEPENDS
        plugins
        rng_options
        mas_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_and_shrink_algorithm_options
    DEPENDS
        plugins
        mas_heuristic
        utils
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/merge_and_shrink_heuristic_feature
    DEPENDS
        plugins
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_scoring_function_category
    DEPENDS
        plugins
        mas_heuristic
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_scoring_function_dfp_feature
    DEPENDS
        plugins
        mas_heuristic
        utils
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_scoring_function_goal_relevance_feature
    DEPENDS
        plugins
        mas_heuristic
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_scoring_function_miasm_feature
    DEPENDS
        plugins
        merge_and_shrink_algorithm_options
        mas_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_scoring_function_single_random_feature
    DEPENDS
        plugins
        rng_options
        mas_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_scoring_function_total_order_feature
    DEPENDS
        plugins
        rng_options
        mas_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_selector_category
    DEPENDS
        plugins
        mas_heuristic
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_selector_score_based_filtering_feature
    DEPENDS
        plugins
        mas_heuristic
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_strategy_factory_category
    DEPENDS
        plugins
        mas_heuristic
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_strategy_factory_precomputed_feature
    DEPENDS
        plugins
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_strategy_factory_sccs_feature
    DEPENDS
        plugins
        merge_strategy_options
        mas_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_strategy_factory_stateless_feature
    DEPENDS
        plugins
        merge_strategy_options
        mas_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_strategy_options
    DEPENDS
        plugins
        logging_options
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_tree_factory_category
    DEPENDS
        plugins
        mas_heuristic
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_tree_factory_linear_feature
    DEPENDS
        plugins
        merge_tree_options
        mas_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/merge_tree_options
    DEPENDS
        plugins
        rng_options
)
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/shrink_bisimulation_feature
    DEPENDS
        plugins
        mas_heuristic
        utils
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/shrink_bucket_based_options
    DEPENDS
        plugins
        rng_options
)
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/shrink_fh_feature
    DEPENDS
        plugins
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/shrink_random_feature
    DEPENDS
        plugins
        shrink_bucket_based_options
        mas_heuristic
...
create_library(
    ...
    SOURCES
    downward_cli/merge_and_shrink/shrink_strategy_category
    DEPENDS
        plugins
        mas_heuristic
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/canonical_pdbs_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
...
create_library(
    ...
    HELP "Canoncial PDBs heuristic feature"
    SOURCES
    downward_cli/heuristics/ipdbs_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
        canonical_pdbs_heuristic_options
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/canonical_pdbs_heuristic_options
    DEPENDS
        plugins
        pdbs
)
...
create_library(
    ...
    HELP "CEGAR options"
    SOURCES
    downward_cli/pdbs/cegar_options
    DEPENDS
        plugins
)
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_collection_generator_combo_feature
    DEPENDS
        plugins
        pattern_generator_options
        pdbs
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_collection_generator_disjoint_cegar_feature
    DEPENDS
        plugins
        rng_options
        cegar_options
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_collection_generator_genetic_feature
    DEPENDS
        plugins
        rng_options
        pattern_generator_options
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_collection_generator_hillclimbing_feature
    DEPENDS
        plugins
        pattern_collection_generator_hillclimbing_options
        canonical_pdbs_heuristic_options
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_collection_generator_hillclimbing_options
    DEPENDS
        plugins
        rng_options
)
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_collection_generator_manual_feature
    DEPENDS
        plugins
        pattern_generator_options
        pdbs
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_collection_generator_multiple_cegar_feature
    DEPENDS
        plugins
        cegar_options
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_collection_generator_multiple_options
    DEPENDS
        plugins
        pattern_collection_generator_multiple_options
        pattern_generator_options
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_collection_generator_multiple_random_feature
    DEPENDS
        plugins
        pattern_collection_generator_multiple_options
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_collection_generator_systematic_feature
    DEPENDS
        plugins
        pattern_generator_options
        pdbs
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_generator_category
    DEPENDS
        plugins
        pdbs
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_collection_generator_category
    DEPENDS
        plugins
        pdbs
    TARGET
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_generator_cegar_feature
    DEPENDS
        plugins
        cegar_options
        pattern_generator_options
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_generator_greedy_feature
    DEPENDS
        plugins
        pattern_generator_options
        pdbs
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_generator_manual_feature
    DEPENDS
        plugins
        pattern_generator_options
        pdbs
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_generator_options
    DEPENDS
        plugins
        logging_options
)
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/pattern_generator_random_feature
    DEPENDS
        plugins
        pattern_generator_options
        random_pattern_options
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/pdb_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
        pdbs
...
create_library(
    ...
    SOURCES
    downward_cli/pdbs/random_pattern_options
    DEPENDS
        plugins
)
...
create_library(
    ...
    SOURCES
    downward_cli/heuristics/zero_one_pdbs_heuristic_feature
    DEPENDS
        plugins
        heuristic_options
        pdbs
