...
void add_merge_scoring_function_total_order_options_to_feature(Feature& feature)
{
...
std::tuple<AtomicTSOrder, ProductTSOrder, bool, int>
get_merge_scoring_function_total_order_args_from_options(const Options& options)
{
...
public:
        ...
        : TypedFeature("ptotal_order")
    {
        ...
        add_merge_scoring_function_total_order_options_to_feature(*this);
    }
...
protected:
        ...
        const override
    {
        return make_shared_from_arg_tuples<MergeScoringFunctionTotalOrder>(
            get_merge_scoring_function_total_order_args_from_options(options));
    }
};
