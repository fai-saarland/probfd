...
std::shared_ptr<TaskSolverFactory> create_tvi(
    ...
    value_t convergence_epsilon)
{
    return make_shared_from_arg_tuples<MDPSolver>(
        make_shared_from_arg_tuples<TopologicalVISolver>(convergence_epsilon),
...
{
    auto& f = insert_function_definition<create_tvi>(
        nspace,
        "topological_value_iteration");

    f.document_title("Topological Value Iteration");
