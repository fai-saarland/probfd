...
void add_lrtdp_features(Namespace& nspace)
{
    ...
    nspace.insert_function_definitions<LRTDPSolverFeature>();
    nspace.insert_function_definitions<LRTDPFretSolverFeature>();
}
