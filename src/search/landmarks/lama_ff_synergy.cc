...
LamaFFSynergy::LamaFFSynergy(const options::Options &opts)
...
static Synergy *_parse(options::OptionParser &parser) {
    parser.document_synopsis(
        ...
        "(see options::OptionSyntax#Predefinitions), for example:\n"
        "\"hlm,hff=lm_ff_syn(...)\"");
