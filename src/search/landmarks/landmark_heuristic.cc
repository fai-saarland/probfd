#include "landmarks/landmark_heuristic.h"
...
static bool landmark_is_interesting(
    ...
    const landmarks::LandmarkNode& lm_node,
...
void LandmarkHeuristic::initialize(const plugins::Options& opts)
{
    ...
    */
    ...
    lm_status_manager = std::make_unique<LandmarkStatusManager>(*lm_graph);
