#include "downward/search_engines/iterated_search.h"
...
class IteratedSearchFeature
    : public plugins::TypedFeature<SearchEngine, IteratedSearch> {
public:
        ...
        : TypedFeature("iterated")
    {
        ...
        document_note(
            ...
            "```\nwould perform the preprocessing phase of the merge and "
            "shrink heuristic "
        ...
        const utils::Context& context) const override
    {
        ...
        */
        vector<parser::LazyValue> engine_configs =
            options.get<parser::LazyValue>("engine_configs")
                .construct_lazy_list();
