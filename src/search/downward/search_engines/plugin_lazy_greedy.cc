#include "downward/search_engines/lazy_search.h"
#include "downward/search_engines/search_common.h"
...
class LazyGreedySearchFeature
    : public plugins::TypedFeature<SearchEngine, lazy_search::LazySearch> {
public:
        ...
        const override
    {
        ...
        options_copy.set(
            "open",
            search_common::create_greedy_open_list_factory(options));
        shared_ptr<lazy_search::LazySearch> engine =
            make_shared<lazy_search::LazySearch>(options_copy);
        // TODO: The following two lines look fishy. See similar comment in
        // _parse.
