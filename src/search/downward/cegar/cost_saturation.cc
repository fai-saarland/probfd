#include "downward/cegar/cost_saturation.h"

#include "downward/cegar/abstract_state.h"
#include "downward/cegar/abstraction.h"
#include "downward/cegar/cartesian_heuristic_function.h"
#include "downward/cegar/cegar.h"
#include "downward/cegar/refinement_hierarchy.h"
#include "downward/cegar/subtask_generators.h"
#include "downward/cegar/transition_system.h"
...
void CostSaturation::reduce_remaining_costs(const vector<int>& saturated_costs)
{
...
bool CostSaturation::state_is_dead_end(const State& state) const
{
    for (const CartesianHeuristicFunction& function : heuristic_functions) {
        if (function.get_value(state) == INF) return true;
    }
    return false;
}
