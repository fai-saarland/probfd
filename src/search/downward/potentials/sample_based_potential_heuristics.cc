...
static void
filter_dead_ends(PotentialOptimizer& optimizer, vector<State>& samples)
{
...
create_sample_based_potential_functions(const plugins::Options& opts)
{
...
public:
        ...
        const override
    {
        return make_shared<PotentialMaxHeuristic>(
            options,
            create_sample_based_potential_functions(options));
    }
};
