...
#define INSTANTIATE_OPEN_LIST(List) \
    template class List<StateID>; \
    template class List<std::pair<StateID, const GlobalOperator*> >; \
    template class List<std::pair<StateID, std::pair<int, const GlobalOperator*> > >;
