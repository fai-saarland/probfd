...
void SearchEngine::save_result_if_necessary() const
{
...
void SearchEngine::set_state_registry(std::shared_ptr<StateRegistry> state_registry)
{
...
void SearchEngine::add_options_to_parser(options::OptionParser &parser) {
