...
static void
print_value(std::ostream& o, const value_type::value_t value)
{
...
void
print_analysis_result(const value_type::value_t res)
{
...
void
print_initial_state_value(const value_type::value_t value, int spaces)
{
