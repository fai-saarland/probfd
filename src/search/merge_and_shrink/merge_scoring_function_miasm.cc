#include "merge_and_shrink/merge_scoring_function_miasm.h"
...
#include "merge_and_shrink/merge_scoring_function_miasm_utils.h"
    ...
    const vector<pair<int, int>>& merge_candidates)
{
    ...
    for (pair<int, int> merge_candidate : merge_candidates) {
        ...
        unique_ptr<Distances> distances = std::make_unique<Distances>(*product);
...
class MergeScoringFunctionMIASMFeature
    : public plugins::
          TypedFeature<MergeScoringFunction, MergeScoringFunctionMIASM> {
public:
