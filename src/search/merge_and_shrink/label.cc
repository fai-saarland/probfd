...
Label::Label(int id_, int cost_, const vector<GlobalCondition> &prevail_,
...
OperatorLabel::OperatorLabel(int id, int cost, const vector<GlobalCondition> &prevail,
...
CompositeLabel::CompositeLabel(int id, const std::vector<Label *> &parents_)
    : Label(id, parents_[0]->get_cost(), parents_[0]->get_prevail(),
