...
static void print_value(std::ostream& o, const value_t value)
{
    o << std::setprecision(std::numeric_limits<long double>::digits10 + 1)
      << value;
}

void print_analysis_result(const value_t res)
{
...
void print_initial_state_value(const value_t value, int spaces)
{
