...
public:
    ...
    create_component(const Options& opts, const Context& context) const override
    {
        return make_shared_from_arg_tuples<LimitedPruning>(
            opts.get<shared_ptr<downward::PruningMethod>>(context, "pruning"),
            opts.get<double>(context, "min_required_pruning_ratio"),
            opts.get<int>(context, "expansions_before_checking_pruning_ratio"),
