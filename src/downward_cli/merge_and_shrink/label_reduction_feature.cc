...
public:
    ...
    {
        bool lr_before_shrinking = opts.get<bool>(context, "before_shrinking");
        bool lr_before_merging = opts.get<bool>(context, "before_merging");
        ...
        return make_shared_from_arg_tuples<LabelReduction>(
            opts.get<bool>(context, "before_shrinking"),
            opts.get<bool>(context, "before_merging"),
            opts.get<LabelReductionMethod>(context, "method"),
            opts.get<LabelReductionSystemOrder>(context, "system_order"),
