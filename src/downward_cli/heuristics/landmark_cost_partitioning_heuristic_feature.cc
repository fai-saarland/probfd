...
#include "downward_cli/landmarks/landmark_heuristic_options.h"
...
public:
    ...
    create_component(const Options& opts, const Context& context) const override
    {
        return make_shared_from_arg_tuples<
            LandmarkCostPartitioningHeuristicFactory>(
            get_landmark_heuristic_arguments_from_options(context, opts),
            opts.get<CostPartitioningMethod>(context, "cost_partitioning"),
            opts.get<bool>(context, "alm"),
            get_lp_solver_arguments_from_options(context, opts));
    }
};
} // namespace
