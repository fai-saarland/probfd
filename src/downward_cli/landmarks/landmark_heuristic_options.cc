    ...
    const plugins::Options& opts)
{
    return tuple_cat(
        ...
        make_tuple(
            opts.get<shared_ptr<LandmarkFactory>>(context, "lm_factory"),
            opts.get<bool>(context, "pref"),
            opts.get<bool>(context, "prog_goal"),
            opts.get<bool>(context, "prog_gn"),
            opts.get<bool>(context, "prog_r")));
}
