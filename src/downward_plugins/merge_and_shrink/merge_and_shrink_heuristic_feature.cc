...
#include "downward_plugins/merge_and_shrink/merge_and_shrink_algorithm_options.h"
...
using downward_plugins::merge_and_shrink::handle_shrink_limit_options_defaults;
