    ...
    utils::LogProxy& log)
{
    ...
    utils::Kibibytes peak_memory_before = utils::get_peak_memory_in_kib();
    ...
    log << "done!" << endl;
    utils::Kibibytes peak_memory_after = utils::get_peak_memory_in_kib();
    utils::Kibibytes memory_diff = peak_memory_after - peak_memory_before;
