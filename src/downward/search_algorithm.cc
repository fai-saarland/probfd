    ...
    utils::LogProxy& log)
{
    ...
    Kibibytes peak_memory_before = utils::get_peak_memory_in_kib();
    ...
    log << "done!" << endl;
    Kibibytes peak_memory_after = utils::get_peak_memory_in_kib();
    Kibibytes memory_diff = peak_memory_after - peak_memory_before;
