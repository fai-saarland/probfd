...
public:
    std::vector<int>
    create_initial_order(const AbstractTaskTuple& task) override
    {
...
public:
    ...
    create_variable_filter(const AbstractTaskTuple&) override
    {
...
public:
    std::unique_ptr<VariableFilter>
    create_variable_filter(const AbstractTaskTuple& task) override
    {
...
public:
    ...
    create_variable_filter(const AbstractTaskTuple& task) override
    {
        ...
        causal_graph::CausalGraph cg(variables, axioms, operators);
...
public:
    ...
    VariableOrder create_variable_order(const AbstractTaskTuple& task) override
    {
