...
void add_rng_type(language::plugins::Namespace& nspace)
{
    nspace
...
void add_default_rng_function(language::plugins::Namespace& nspace)
{
    nspace.insert_function_definition("get_default_rng", get_default_rng);
}

void add_seeded_rng_function(language::plugins::Namespace& nspace)
{
    nspace.insert_function_definition("get_seeded_rng", get_seeded_rng);
}
