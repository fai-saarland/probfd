...
public:
    MergeAndShrinkHeuristicFeature()
        : TypedFeature(
              "merge_and_shrink",
              &MergeAndShrinkHeuristicFeature::func)
    {
        ...
        const auto n = add_transition_system_size_limit_options_to_feature(
            *this,
            5);
        ...
        add_heuristic_options_to_feature(*this, "merge_and_shrink", n + 6);
    }
...
class MergeAndShrinkHeuristicNoLabelReductionFeature
    : public SharedTypedFeature<
          TaskDependentFactory<Evaluator>,
          shared_ptr<TaskTransformation>,
          bool,
          ...
          FSeconds> {
public:
    MergeAndShrinkHeuristicNoLabelReductionFeature()
        : TypedFeature(
              "merge_and_shrink_no_lr",
              &MergeAndShrinkHeuristicNoLabelReductionFeature::func)
    {
        document_title("Merge-and-shrink heuristic");
        document_synopsis(
            "This heuristic implements the algorithm described in the "
        ...
        add_heuristic_options_to_feature(*this, "merge_and_shrink", n + 5);
    }
