...
#include "probfd_cli/solvers/mdp_heuristic_search_options.h"
...
protected:
        ...
        const override
    {
        ...
        bool forward_updates = options.get<bool>(context, "fwup");
        auto backward_updates =
            options.get<BacktrackingUpdateType>(context, "bwup");
        bool cutoff_tip = options.get<bool>(context, "cutoff_tip");
        bool cutoff_inconsistent =
            options.get<bool>(context, "cutoff_inconsistent");
        bool labeling = options.get<bool>(context, "labeling");
        ...
        return make_shared_from_arg_tuples<MDPSolver>(
            make_shared_from_arg_tuples<DFHSSolver<Bisimulation, Fret>>(
                ...
                cutoff_inconsistent,
                labeling,
                get_mdp_hs_args_from_options<Bisimulation, Fret>(
                    context,
                    options)),
