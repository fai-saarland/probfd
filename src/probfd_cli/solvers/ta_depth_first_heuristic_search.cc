        ...
        const override
    {
        return make_shared_from_arg_tuples<MDPSolver>(
            make_shared_from_arg_tuples<TrapAwareDFHSSolver>(
                options.get<std::shared_ptr<QOpenList>>(context, "open_list"),
                options.get<bool>(context, "fwup"),
                options.get<BacktrackingUpdateType>(context, "bwup"),
                options.get<bool>(context, "cutoff_tip"),
                options.get<bool>(context, "cutoff_inconsistent"),
                options.get<bool>(context, "labeling"),
                options.get<bool>(context, "reexpand_traps"),
