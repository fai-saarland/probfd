...
public:
    LRTDPSolverFeature()
        : TypedFeature(add_wrapper_algo_suffix<Bisimulation, Fret>("lrtdp"))
    {
...
protected:
        ...
        const override
    {
        ...
        const auto trial_termination = options.get<TrialTerminationCondition>(
            context,
            "trial_termination");
        ...
        return make_shared_from_arg_tuples<MDPSolver>(
            make_shared_from_arg_tuples<LRTDPSolver<Bisimulation, Fret>>(
                options.get<std::shared_ptr<Sampler>>(
                    context,
                    "successor_sampler"),
                options.get<TrialTerminationCondition>(
                    context,
                    "trial_termination"),
