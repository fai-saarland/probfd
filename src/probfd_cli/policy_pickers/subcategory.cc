...
public:
    ...
    {
        return std::make_shared<R>(opts.get<bool>(context, "stable_policy"));
    }
};
...
public:
    ...
    create_component(const Options& opts, const Context& context) const override
    {
        return make_shared_from_arg_tuples<OperatorIdTiebreaker>(
            opts.get<bool>(context, "stable_policy"),
            opts.get<bool>(context, "prefer_smaller"));
    }
};
...
public:
    ...
    create_component(const Options& opts, const Context& context) const override
    {
        return make_shared_from_arg_tuples<R>(
            opts.get<bool>(context, "stable_policy"),
            opts.get<bool>(context, "prefer_large_gaps"));
    }
};
} // namespace
